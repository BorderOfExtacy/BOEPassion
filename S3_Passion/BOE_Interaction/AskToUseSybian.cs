...
namespace S3_Passion.BOE_Interaction
{
	internal sealed class AskToUseSybian : ImmediateInteraction<Sim, Sybian>
	{
		...
		public override bool Run()
		{
			...
			sim.InteractionQueue.AddNext(Interactions.UseObjectForPassion.Singleton.CreateInstance(Target, sim, new InteractionPriority(InteractionPriorityLevel.RequiredNPCBehavior), false, true));
			return true;
		}
