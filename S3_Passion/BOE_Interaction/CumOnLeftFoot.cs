...
namespace S3_Passion.BOE_Interaction
{
	internal sealed class CumOnLeftFoot : ImmediateInteraction<Sim, Sim>
	{
		...
		public override bool Run()
		{
			...
			{
				SimMessage(Localization.LocalizeString("Now you want me ejaculate on my Feet! Will you clean them?"), Actor);
			}
			...
			if ((Actor.IsMale && Actor != Target && PersistableSettings.Settings.UseCondom && PersistableSettings.Settings.CondomIsBroken) || (Actor.IsMale && Actor != Target && !PersistableSettings.Settings.UseCondom) || (IsTransfem(Actor) && !IsTransfem(Target) && PersistableSettings.Settings.UseCondom && PersistableSettings.Settings.CondomIsBroken) || (IsTransfem(Actor) && !IsTransfem(Target) && !PersistableSettings.Settings.UseCondom))
			{
			...
			if ((Actor.IsFemale && !IsTransfem(Actor) && Target.IsMale && PersistableSettings.Settings.UseCondom && PersistableSettings.Settings.CondomIsBroken) || (Actor.IsFemale && !IsTransfem(Actor) && Target.IsMale && !PersistableSettings.Settings.UseCondom) || (Actor.IsFemale && !IsTransfem(Actor) && IsTransfem(Target) && PersistableSettings.Settings.UseCondom && PersistableSettings.Settings.CondomIsBroken) || (Actor.IsFemale && !IsTransfem(Actor) && IsTransfem(Target) && !PersistableSettings.Settings.UseCondom))
			{
