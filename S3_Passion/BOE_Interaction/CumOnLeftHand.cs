...
namespace S3_Passion.BOE_Interaction
{
	internal sealed class CumOnLeftHand : ImmediateInteraction<Sim, Sim>
	{
		...
		public override bool Run()
		{
			...
			if ((Actor.IsMale && PersistableSettings.Settings.UseCondom && PersistableSettings.Settings.CondomIsBroken) || (Actor.IsMale && !PersistableSettings.Settings.UseCondom) || (IsTransfem(Actor) && PersistableSettings.Settings.UseCondom && PersistableSettings.Settings.CondomIsBroken) || (IsTransfem(Actor) && !PersistableSettings.Settings.UseCondom))
			{
