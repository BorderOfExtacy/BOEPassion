...
namespace S3_Passion.BOE_Settings
{
	...
	public class PassionSettings : ModalDialog
	{
		...
		public class SettingsBufferObject
		{
			...
			{
				Outfit = PersistableSettings.Settings.Outfit;
				Motives = PersistableSettings.Settings.Motives;
				InitialCategory = PersistableSettings.Settings.InitialCategory;
				NakedShower = PersistableSettings.Settings.NakedShower;
			}

			public void Save()
			{
                PersistableSettings.Settings.Outfit = Outfit;
                PersistableSettings.Settings.Motives = Motives;
                PersistableSettings.Settings.InitialCategory = InitialCategory;
                PersistableSettings.Settings.NakedShower = NakedShower;
			}
		}
