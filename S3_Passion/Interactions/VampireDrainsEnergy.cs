...
namespace Passion.S3_Passion.Interactions
{
    ...
    {
        [DoesntRequireTuning]
        private sealed class Definition : InteractionDefinition<Sim, Sim, VampireDrainsEnergy>, IHasTraitIcon,
            IHasMenuPathIcon
        {
            ...
            {
                return Localization.LocalizeString(target.IsFemale, "Drain Energy", target.SimDescription,
                ...
                ref GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return GameUtils.IsInstalled(ProductVersion.EP7) && actor.SimDescription.IsVampire &&
                       ...
                       !target.SimDescription.IsRobot && target != actor &&
                       !target.TraitManager.HasElement(TraitNames.SuperVampire) && !target.SimDescription.IsEP11Bot &&
                       !target.SimDescription.ChildOrBelow && !target.SimDescription.IsBonehilda &&
                       !target.SimDescription.IsPet && PassionCore.Settings.VampireInteractions;
            }
        }
        ...
        public override bool Run()
        {
            ...
            ThoughtBalloonManager.BalloonData balloonData =
                new ThoughtBalloonManager.BalloonData(Target.GetThumbnailKey());
