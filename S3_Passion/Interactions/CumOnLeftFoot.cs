...
{
    internal sealed class CumOnLeftFoot : ImmediateInteraction<Sim, Sim>
    {
        [DoesntRequireTuning]
        private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, CumOnLeftFoot>
        {
            public override string GetInteractionName(Sim actor, Sim target, InteractionObjectPair interaction)
            {
                return Localization.LocalizeString("CumOnLeftFoot");
            }
        ...
        private Sim.SwitchOutfitHelper SwitchOutfitHelper
        {
            ...
            set
            {
                if (_mSwitchOutfitHelper == value) return;
        ...
        public override bool Run()
        {
            ...
            {
                SimMessage(Localization.LocalizeString("Now you want me ejaculate on my Feet! Will you clean them?"),
                    Actor);
            }
            ...
            if ((Actor.IsMale && Actor != Target && PassionCore.Settings.UseCondom && PassionCore.Settings.CondomIsBroken) ||
                (Actor.IsMale && Actor != Target && !PassionCore.Settings.UseCondom) ||
                (IsTransfem(Actor) && !IsTransfem(Target) && PassionCore.Settings.UseCondom &&
                ...
                (IsTransfem(Actor) && !IsTransfem(Target) && !PassionCore.Settings.UseCondom))
            {
                ...
                ResourceKey resourceKey2 = ResourceKey.FromString("0x034AEECB-0x00000000-0x183A9906434E03C7");
                SimDescription simDescription2 = Target.SimDescription;
                SimOutfit simOutfit2 = null;
                if (resourceKey2 != kInvalidResourceKey)
                {
                    simOutfit2 = new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0xDF826C4AA87F152C"));
                }
            ...
            ResourceKey resourceKey4 = ResourceKey.FromString("0x034AEECB-0x00000000-0x183A9906434E03C7");
            SimDescription simDescription4 = Actor.SimDescription;
            SimOutfit simOutfit4 = null;
            if (resourceKey4 != kInvalidResourceKey2)
            {
                simOutfit4 = new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0xDF826C4AA87F152C"));
            }
