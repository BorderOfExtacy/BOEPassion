...
namespace Passion.S3_Passion.Interactions
{
	...
	{
		[DoesntRequireTuning]
		private sealed class Definition : InteractionDefinition<Sim, Sim, VampireAttacked>, IHasTraitIcon, IHasMenuPathIcon
		{
			...
			{
				return GameUtils.IsInstalled(ProductVersion.EP7) && PassionCore.Settings.VampireInteractions;
			}
		}
