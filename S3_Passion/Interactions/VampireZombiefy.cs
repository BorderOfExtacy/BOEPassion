...
namespace Passion.S3_Passion.Interactions
{
    ...
    {
        [DoesntRequireTuning]
        private sealed class Definition : InteractionDefinition<Sim, Sim, VampireZombiefy>, IHasTraitIcon,
            IHasMenuPathIcon
        {
            ...
            {
                return Localization.LocalizeString(target.IsFemale, "Vampire Zombiefy", target.SimDescription,
                ...
                ref GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return GameUtils.IsInstalled(ProductVersion.EP7) && target != a &&
                       PassionCore.Settings.VampireInteractions && !target.IsActiveSim &&
        ...
        public override bool Run()
        {
            ...
            if (!BeginSocialInteraction(new SocialInteractionB.Definition(), false, 0.75f, true)) return false;
