...
{
    internal sealed class CumOnBelly : ImmediateInteraction<Sim, Sim>
    {
        [DoesntRequireTuning]
        ...
        public override bool Run()
        {
            ...
            ResourceKey resourceKey4 = ResourceKey.FromString("0x034AEECB-0x00000000-0x448E28850CC102D6");
            SimDescription simDescription4 = Actor.SimDescription;
            SimOutfit simOutfit4 = null;
            if (resourceKey4 != kInvalidResourceKey2)
            {
                simOutfit4 = new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x4C25D388A71924C7"));
            }
