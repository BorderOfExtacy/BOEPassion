...
{
    internal sealed class CumOnTits : ImmediateInteraction<Sim, Sim>
    {
        [DoesntRequireTuning]
        ...
        public override bool Run()
        {
            ...
            {
                SimMessage(Localization.LocalizeString("You want me ejaculate on my tits? You see tits on me now?"),
                    Actor);
            }
            ...
            if (IsTransfem(Actor) && IsTransfem(Target))
            {
                SimMessage(
                    Localization.LocalizeString(
                        "You want me ejaculate on my tits? I prefer a handsome young man to that!"), Actor);
            }
                ...
                (IsTransfem(Actor) && !IsTransfem(Target) && !PassionCore.Settings.UseCondom))
            {
                ...
                ResourceKey resourceKey2 = ResourceKey.FromString("0x034AEECB-0x00000000-0x1FD9B0884C514134");
                SimDescription simDescription2 = Target.SimDescription;
                SimOutfit simOutfit2 = null;
                if (resourceKey2 != kInvalidResourceKey)
                {
                    simOutfit2 = new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x01CCF0AAA281656F"));
                }
            ...
            ResourceKey resourceKey4 = ResourceKey.FromString("0x034AEECB-0x00000000-0x1FD9B0884C514134");
            SimDescription simDescription4 = Actor.SimDescription;
            SimOutfit simOutfit4 = null;
            if (resourceKey4 != kInvalidResourceKey2)
            {
                simOutfit4 = new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x01CCF0AAA281656F"));
            }
