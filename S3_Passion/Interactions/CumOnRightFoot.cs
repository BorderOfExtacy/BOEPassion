...
namespace Passion.S3_Passion.Interactions
{
    ...
    {
        [DoesntRequireTuning]
        private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, CumOnRightFoot>
        {
            public override string GetInteractionName(Sim actor, Sim target, InteractionObjectPair interaction)
            {
                return Localization.LocalizeString("CumOnRightFoot");
            }
        ...
        public override bool Run()
        {
                ...
                (IsTransfem(Actor) && !IsTransfem(Target) && !PassionCore.Settings.UseCondom))
            {
                ...
                ResourceKey resourceKey2 = ResourceKey.FromString("0x034AEECB-0x00000000-0x32C2ECD157EFBEF1");
                SimDescription simDescription2 = Target.SimDescription;
                SimOutfit simOutfit2 = null;
                if (resourceKey2 != kInvalidResourceKey)
                {
                    simOutfit2 = new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x8DD05D6B4D7E029D"));
                }
            ...
            ResourceKey resourceKey4 = ResourceKey.FromString("0x034AEECB-0x00000000-0x32C2ECD157EFBEF1");
            SimDescription simDescription4 = Actor.SimDescription;
            SimOutfit simOutfit4 = null;
            if (resourceKey4 != kInvalidResourceKey2)
            {
                simOutfit4 = new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x8DD05D6B4D7E029D"));
            }
