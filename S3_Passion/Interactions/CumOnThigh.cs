...
{
    internal sealed class CumOnThigh : ImmediateInteraction<Sim, Sim>
    {
        [DoesntRequireTuning]
        private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, CumOnThigh>
        {
            public override string GetInteractionName(Sim actor, Sim target, InteractionObjectPair interaction)
            {
                return Localization.LocalizeString("CumOnThigh");
            }
        ...
        public override bool Run()
        {
                ...
                (IsTransfem(Actor) && !PassionCore.Settings.UseCondom))
            {
                ...
                ResourceKey resourceKey2 = ResourceKey.FromString("0x034AEECB-0x00000000-0x52217E8D62B05581");
                SimDescription simDescription2 = Target.SimDescription;
                SimOutfit simOutfit2 = null;
                if (resourceKey2 != kInvalidResourceKey)
                {
                    simOutfit2 = new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x1A0C2D9000D10312"));
                }
            ...
            ResourceKey resourceKey4 = ResourceKey.FromString("0x034AEECB-0x00000000-0x52217E8D62B05581");
            SimDescription simDescription4 = Actor.SimDescription;
            SimOutfit simOutfit4 = null;
            if (resourceKey4 != kInvalidResourceKey2)
            {
                simOutfit4 = new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x1A0C2D9000D10312"));
            }
