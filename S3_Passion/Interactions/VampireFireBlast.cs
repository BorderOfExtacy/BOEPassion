...
namespace Passion.S3_Passion.Interactions
{
    ...
    {
        [DoesntRequireTuning]
        private sealed class Definition : InteractionDefinition<Sim, Sim, VampireFireBlast>, IHasTraitIcon,
            IHasMenuPathIcon
        {
            ...
            {
                return Localization.LocalizeString(target.IsFemale, "Vampire Fire Blast", target.SimDescription,
            ...
            {
                return GameUtils.IsInstalled(ProductVersion.EP7) && actor.SimDescription.IsVampire && target != actor &&
                       ...
                       !target.SimDescription.IsPet && !target.SimDescription.IsWildAnimal &&
                       !target.SimDescription.IsPregnant && PassionCore.Settings.VampireInteractions &&
