...
namespace Passion.S3_Passion.Interactions
{
    public class VampireBites : SocialInteraction
    {
        ...
        public sealed class Definition : InteractionDefinition<Sim, Sim, VampireBites>, IHasTraitIcon, IHasMenuPathIcon
        {
            ...
            {
                return Localization.LocalizeString(target.IsFemale, "Vampire Bite", target.SimDescription,
                ...
                ref GreyedOutTooltipCallback greyedOutTooltipCallback)
            {
                return GameUtils.IsInstalled(ProductVersion.EP7) && target != a &&
                       ...
                       !target.BuffManager.HasElement(BuffNames.WhatJustHappened) &&
                       a.BuffManager.HasElement(BuffNames.VampiricVigor) && PassionCore.Settings.VampireInteractions;
            }
        }
        ...
        public override bool Run()
        {
            ...
            if (!Target.BuffManager.HasElement(BuffNames.WhatJustHappened) &&
                Actor.BuffManager.HasElement(BuffNames.VampiricVigor) &&
                !Actor.BuffManager.HasElement(BuffNames.VampireBite) &&
                (long)Actor.SkillManager.GetSkillLevel(SkillNames.Charisma) != 10)
            {
