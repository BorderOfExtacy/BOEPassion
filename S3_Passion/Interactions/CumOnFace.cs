...
{
    internal sealed class CumOnFace : ImmediateInteraction<Sim, Sim>
    {
        [DoesntRequireTuning]
        private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, CumOnFace>
        {
            public override string GetInteractionName(Sim actor, Sim target, InteractionObjectPair interaction)
            {
                return Localization.LocalizeString("CumOnFace");
            }
            ...
            {
                return PassionCore.CumInteractions;
            }
        }
        ...
        {
            get { return _mSwitchOutfitHelper; }
            set
            {
        ...
        public override bool Run()
        {
            if ((Actor.IsMale && Actor == Target) || (IsTransfem(Actor) && IsTransfem(Target)))
            {
                SimMessage(
                    Localization.LocalizeString(
                        "You want me to ejaculate on my face? Come close to the screen. I prefer yours!"), Actor);
            }
            ...
            if ((Actor.IsMale && Actor != Target && !PassionCore.Settings.UseCondom) ||
                (Actor.IsMale && Actor != Target && PassionCore.Settings.UseCondom && PassionCore.Settings.CondomIsBroken) ||
                (IsTransfem(Actor) && !IsTransfem(Target) && !PassionCore.Settings.UseCondom) || (IsTransfem(Actor) &&
                    !IsTransfem(Target) && PassionCore.Settings.UseCondom && PassionCore.Settings.CondomIsBroken))
            {
                ...
                if (resourceKey != kInvalidResourceKey)
                {
                    if (!IsSmPeener(Actor))
                    {
                        ...
                        {
                            SimOutfit simOutfit =
                                new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x5DA2AF30FC4A0425"));
                            SimOutfit resultOutfit;
                            if (OutfitUtils.TryApplyUniformToOutfit(simDescription.GetOutfit(OutfitCategories.Naked, 0),
                                    simOutfit, simDescription, "CumShot", out resultOutfit))
                            {
                    ...
                    ResourceKey resourceKey2 = ResourceKey.FromString("0x034AEECB-0x00000000-0x6FA4416A56A9C9C2");
                    SimDescription simDescription2 = Target.SimDescription;
                    SimOutfit simOutfit2 = null;
                    if (resourceKey2 != kInvalidResourceKey)
                    {
                        simOutfit2 = new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x7CCCFCBB68B3E3D3"));
                    }

                    if (simOutfit2 == null || Target.CurrentOutfitCategory != OutfitCategories.Naked) return true;
                    SimOutfit resultOutfit2;
                    if (OutfitUtils.TryApplyUniformToOutfit(simDescription2.GetOutfit(OutfitCategories.Naked, 0),
                            simOutfit2, simDescription2, "CumMask", out resultOutfit2))
                    {
            ...
            if ((!Actor.IsFemale || IsTransfem(Actor) || !Target.IsMale || PassionCore.Settings.UseCondom) &&
                (!Actor.IsFemale || IsTransfem(Actor) || !Target.IsMale || !PassionCore.Settings.UseCondom ||
                 !PassionCore.Settings.CondomIsBroken) &&
                (!Actor.IsFemale || IsTransfem(Actor) || !IsTransfem(Target) || PassionCore.Settings.UseCondom) &&
                (!Actor.IsFemale || IsTransfem(Actor) || !IsTransfem(Target) || !PassionCore.Settings.UseCondom ||
                 !PassionCore.Settings.CondomIsBroken)) return false;
            ...
            if (!IsSmPeener(Target))
            {
                try
                {
                    SimOutfit simOutfit3 =
                        new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x5DA2AF30FC4A0425"));
                    SimOutfit resultOutfit3;
                    if (OutfitUtils.TryApplyUniformToOutfit(simDescription3.GetOutfit(OutfitCategories.Naked, 0),
                            simOutfit3, simDescription3, "CumShot", out resultOutfit3))
                    {
            ...
            ResourceKey resourceKey4 = ResourceKey.FromString("0x034AEECB-0x00000000-0x6FA4416A56A9C9C2");
            SimDescription simDescription4 = Actor.SimDescription;
            SimOutfit simOutfit4 = null;
            if (resourceKey4 != kInvalidResourceKey2)
            {
                simOutfit4 = new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x7CCCFCBB68B3E3D3"));
            }

            if (simOutfit4 == null || Actor.CurrentOutfitCategory != OutfitCategories.Naked) return true;
            SimOutfit resultOutfit4;
            if (OutfitUtils.TryApplyUniformToOutfit(simDescription4.GetOutfit(OutfitCategories.Naked, 0), simOutfit4,
                    simDescription4, "CumMask", out resultOutfit4))
            {
        ...
        private static bool IsTransfem(Sim sim)
        {
            ...
            if (simDescription.GetOutfit(OutfitCategories.Naked, 0)
                    .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0xB25D1F4F442041E6")) != null)
            {
                return true;
            }

            if (simDescription.GetOutfit(OutfitCategories.Naked, 0)
                    .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0x23697088F9BC3EA8")) != null)
            {
                return true;
            }

            return simDescription.GetOutfit(OutfitCategories.Naked, 0)
        ...
        private static bool IsSmPeener(Sim sim)
        {
            SimDescription simDescription = sim.SimDescription;
            return simDescription.GetOutfit(OutfitCategories.Naked, 0)
                .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0x0603B3F0BE3C7883")) != null;
        }
    }
}