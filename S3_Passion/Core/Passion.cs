...
using System.Text;
using System.Xml;
using Passion.S3_Passion.Interactions;
...
namespace Passion.S3_Passion.Core
{
    public class Passion : PassionCommon
    {
        ...
        public class PersistableSettings
        {
            ...
            public bool UseCondom;

            public bool RemoveCondom;

            public bool CondomIsBroken;

            public bool PassionFuckSession;

            public int CondomBrakeChance;
            ...
            public static void Show(string message, bool defaultValue, string yesOption, string noOption,
                float TOLERANCE)
            {
                bool flag = true;
                List<ObjectPicker.HeaderInfo> list = new List<ObjectPicker.HeaderInfo>();
                list.Add(new ObjectPicker.HeaderInfo(PassionCommon.Localize("S3_Passion.Terms.Setting"),
                    null, 250));
                list.Add(new ObjectPicker.HeaderInfo(PassionCommon.Localize("S3_Passion.Terms.Value"), null,
                    200));
                while (flag)
                {
                    // settings UI display
                    ...
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.Reset, true),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.ResetToDefaults")
                        ));
                    rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(" "));
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.ExportImport, true),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn("* " + PassionCommon.Localize("S3_Passion.Terms.SettingsFile") +
                                                    " *"));
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.ImportExport")
                        ));
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.ExportImportSequence, true),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn("** " +
                                                                       PassionCommon.Localize(
                                                                           "S3_Passion.Terms.Sequence.SettingsFile") +
                                                                       " **"));
                    rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(PassionCommon
                        .Localize("S3_Passion.Terms.Sequence.ImportExportSequence").ToString()));
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.AutonomyChance, Settings.AutonomyChance),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn("* " + PassionCommon.Localize("S3_Passion.Terms.Autonomy") + " *"));
                    rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn((Settings.AutonomyChance > 0)
                        ? (Settings.AutonomyChance + "%, " + PassionCommon.TicksToMinutes(Settings.AutonomyLength) +
                           " Min.")
                        : PassionCommon.Localize("S3_Passion.Terms.Disabled").ToString()));
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.Eligibility, true),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(
                            "* " + PassionCommon.Localize("S3_Passion.Terms.Eligibility") + " *"));
                    rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn("A " +
                                                                       (Settings.Incest
                                                                           ? PassionCommon
                                                                               .Localize("S3_Passion.Terms.Enabled")
                                                                               .ToString()
                                                                           : string.Empty) + ", T " +
                                                                       (Settings.Teen
                                                                           ? PassionCommon
                                                                           ...
                                                                           : string.Empty)));
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.Positions, Positions),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn("* " + PassionCommon.Localize("S3_Passion.Terms.Positions") +
                                                    " *"));
                    rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn("(" + Positions.Count + ")"));
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.Sequences, Sequences),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn("* " + PassionCommon.Localize("S3_Passion.Terms.Sequences") +
                                                    " *"));
                    rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn("(" + Sequences.Count + ")"));
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.EndWhenFull, Settings.EndWhenFull),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.EndWhenFull").ToString()));
                    if (Settings.EndWhenFull != null)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Enabled").ToString()));
                    }
                    else
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Disabled")
                                .ToString()));
                    }

                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(
                        new SettingItem(Setting.ExludeInvalidPositions, Settings.ExcludeInvalidPositions),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(PassionCommon
                        .Localize("S3_Passion.Terms.ExcludeInvalidPositions").ToString()));
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(
                        new SettingItem(Setting.VampireInteractions, Settings.VampireInteractions),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(PassionCommon
                        .Localize("S3_Passion.Terms.VampireInteractions").ToString()));
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.ChildrenOut, Settings.ChildrenOut),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.ChildrenOut").ToString()));
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.PetsOut, Settings.PetsOut),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.PetsOut").ToString()));
                    if (Settings.PetsOut)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Enabled").ToString()));
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.EldersOut, Settings.EldersOut),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.EldersOut").ToString()));
                    ...
                    {
                        rowInfo = new ObjectPicker.RowInfo(
                            new SettingItem(Setting.VampiresVisitAtNight, Settings.VampiresVisitAtNight),
                            new List<ObjectPicker.ColumnInfo>());
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(PassionCommon
                            .Localize("S3_Passion.Terms.VampiresVisitAtNight").ToString()));
                        if (Settings.VampiresVisitAtNight)
                        {
                            rowInfo.ColumnInfo.Add(
                                new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Enabled")
                                    .ToString()));
                        }
                        else
                        {
                    ...
                    {
                        rowInfo = new ObjectPicker.RowInfo(
                            new SettingItem(Setting.VampireHypnoSex, Settings.VampireHypnoSex),
                            new List<ObjectPicker.ColumnInfo>());
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(PassionCommon
                            .Localize("S3_Passion.Terms.VampireHypnoSex").ToString()));
                    ...
                    if (Settings.VampireInteractions)
                    {
                        rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.EvilFighter, Settings.EvilFighter),
                            new List<ObjectPicker.ColumnInfo>());
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.EvilFighter")
                                .ToString()));
                    ...
                    {
                        rowInfo = new ObjectPicker.RowInfo(
                            new SettingItem(Setting.RemoveVisualOverride, Settings.RemoveVisualOverride),
                            new List<ObjectPicker.ColumnInfo>());
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(PassionCommon
                            .Localize("S3_Passion.Terms.RemoveVisualOverride").ToString()));
                    ...
                    rowInfo = new ObjectPicker.RowInfo(
                        new SettingItem(Setting.BroadCasterEnable, Settings.BroadCasterEnable),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(PassionCommon
                        .Localize("S3_Passion.Terms.BroadCasterEnable").ToString()));
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(
                        new SettingItem(Setting.FemaleUseStrapOn, Settings.FemaleUseStrapOn),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.FemaleUseStrapOn")
                            .ToString()));
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(
                        new SettingItem(Setting.StripperAutonomy, Settings.StripperAutonomy),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.StripperAutonomy")
                            .ToString()));
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(
                        new SettingItem(Setting.InitialCategory, Settings.InitialCategory),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.InitialCategory")
                            .ToString()));
                    if (Settings.InitialCategory == 1024)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Choose").ToString()));
                    }
                    else if (Settings.InitialCategory == 12)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Fuck").ToString()));
                    }
                    else if (Settings.InitialCategory == 48)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(
                                PassionCommon.Localize("S3_Passion.Terms.Masturbate").ToString()));
                    }
                    else if (Settings.InitialCategory == 2)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Oral")));
                    }
                    else
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Any")));
                    }

                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.Jealousy, Settings.Jealousy),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Jealousy")));
                    if (Settings.Jealousy)
                    {
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(
                            PassionCommon.Localize("S3_Passion.Terms.Enabled") +
                            (Settings.PolyamorousJealousy ? "*" : "")));
                    }
                    else
                    {
                        rowInfo.ColumnInfo.Add(
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.Label, Settings.Label),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Label")));
                    rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(Settings.Label + "/" + Settings.ActiveLabel +
                                                                       "/" + Settings.SoloLabel));
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.MaxLength, Settings.MaxLength),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.MaxLength")));
                    if (Settings.MaxLength < 10)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Infinite")));
                    }
                    else
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.TicksToMinutes(Settings.MaxLength) + " Minutes"));
                    }

                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.Moodlets, true),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Moodlets")));
                    if (Settings.LibidoBuff && Settings.WoohooBuff)
                    {
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(
                            PassionCommon.Localize("S3_Passion.Terms.Libido") + ", " +
                            PassionCommon.Localize("S3_Passion.Terms.WoohooBuff")));
                    }
                    else if (Settings.LibidoBuff)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Libido")));
                    }
                    else if (Settings.WoohooBuff)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.WoohooBuff")));
                    }
                    else
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.None")));
                    }

                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.Motives, Settings.Motives),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Motives")));
                    if (Settings.Motives == PassionMotives.NoDecay)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.NoDecay")));
                    }
                    else if (Settings.Motives == PassionMotives.PassionStandard)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.PassionStandard")));
                    }
                    else if (Settings.Motives == PassionMotives.Freeze)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Freeze")));
                    }
                    else if (Settings.Motives == PassionMotives.MaxAll)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.MaxAll")));
                    }
                    else
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.EADefault")));
                    }

                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.Outfit, Settings.Outfit),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Outfit")));
                    if (Settings.Outfit == OutfitCategories.Naked)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Naked")));
                    }
                    else if (Settings.Outfit == OutfitCategories.Sleepwear)
                    {
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(
                            PassionCommon.Localize("S3_Passion.Terms.Sleepwear") + (Settings.NakedShower ? "*" : "")));
                    }
                    else
                    {
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(
                            PassionCommon.Localize("S3_Passion.Terms.PreferredOnly") +
                            (Settings.NakedShower ? "*" : "")));
                    }

                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(
                        new SettingItem(Setting.PregnancyMethod, Settings.PregnancyMethod),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Pregnancy")));
                    if (Settings.PregnancyMethod == PregnancyMethod.ByCategory)
                    {
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(
                            PassionCommon.Localize("S3_Passion.Terms.Category") + " (" + Settings.PregnancyRisk +
                            "%)"));
                    }
                    else if (Settings.PregnancyMethod == PregnancyMethod.ByPosition)
                    {
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(
                            PassionCommon.Localize("S3_Passion.Terms.Position") + " (" + Settings.PregnancyRisk +
                            "%)"));
                    }
                    else if (Settings.PregnancyMethod == PregnancyMethod.KwSystem)
                    {
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(
                            PassionCommon.Localize("S3_Passion.Terms.KWSystem") + " (" + Settings.PregnancyRisk +
                            "%)"));
                    }
                    else
                    {
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.UseCondom, Settings.UseCondom),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.UseCondom")));
                    if (Settings.UseCondom)
                    {
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(
                            PassionCommon.Localize("S3_Passion.Terms.CondomBrakeChance") + " (" +
                            Settings.CondomBrakeChance + "%)"));
                    }
                    else
                    {
                        rowInfo.ColumnInfo.Add(
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(
                        new SettingItem(Setting.RandomizationOptions, Settings.RandomizationOptions),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Randomization")));
                    if ((RandomizationOptions.PositionsAndSequences & Settings.RandomizationOptions) ==
                        RandomizationOptions.PositionsAndSequences)
                    {
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(
                            PassionCommon.Localize("S3_Passion.Terms.Positions") + "/" +
                            PassionCommon.Localize("S3_Passion.Terms.Sequences") +
                            ((Settings.RandomizationLength > 0)
                                ? (" (" + PassionCommon.TicksToMinutes(Settings.RandomizationLength) + " min.)")
                                : string.Empty) +
                            (PassionCommon.Match(RandomizationOptions.SameCategory, Settings.RandomizationOptions)
                                ? "*"
                                : string.Empty)));
                    }
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.GetHard, Settings.GetHard),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.PenisAddOn")));
                    if (Settings.GetHard)
                    {
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn(
                            PassionCommon.Localize("S3_Passion.Terms.HardBefore") + (Settings.GetSoft
                                ? (", " + PassionCommon.Localize("S3_Passion.Terms.SoftAfter") +
                                   (Settings.StrapOnMode ? "*" : string.Empty))
                                : string.Empty)));
                    }
                    ...
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Neither")));
                    }

                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.CanReject, Settings.CanReject),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Rejection")));
                    if (Settings.CanReject && Math.Abs(Settings.RelationshipLoss - (-15f)) < TOLERANCE)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Enabled") + " (--)"));
                    }
                    else if (Settings.CanReject && Math.Abs(Settings.RelationshipLoss - (-8f)) < TOLERANCE)
                    {
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Enabled") + " (-)"));
                    }
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(
                        new SettingItem(Setting.RelationshipGain, Settings.RelationshipGain),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.RelationshipGain")));
                    ...
                    list3.Add(rowInfo);
                    rowInfo = new ObjectPicker.RowInfo(new SettingItem(Setting.Std, Settings.Std),
                        new List<ObjectPicker.ColumnInfo>());
                    rowInfo.ColumnInfo.Add(
                        new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.STDs")));
                    rowInfo.ColumnInfo.Add(
                        Settings.Std
                            ? new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Enabled"))
                            : new ObjectPicker.TextColumn(PassionCommon.Localize("S3_Passion.Terms.Disabled")));
                    ...
                    list3.Add(rowInfo);
                    ObjectPicker.TabInfo tabInfo = new ObjectPicker.TabInfo("shop_skill_r2",
                        PassionCommon.Localize("S3_Passion.Terms.General"), list3);
                    if (tabInfo.RowInfo.Count >= 0)
                    {
                        list2.Add(tabInfo);
                    }

                    List<ObjectPicker.RowInfo> list4 = MenuList.Show(
                        PassionCommon.Localize("S3_Passion.Terms.Settings") + "\rPassion Version ( " +
                        PassionCommon.Version + " )", PassionCommon.Localize("S3_Passion.Terms.Ok"),
                        PassionCommon.Localize("S3_Passion.Terms.Cancel"), list2, list);
                    ...
                    switch (settingItem.Name)
                    {
                        case Setting.Reset:
                            if (!PickBoolean.Show(
                                    PassionCommon.Localize("S3_Passion.Terms.ResetToDefaultsConfirmation"), false,
                                    PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No")))
                            {
                                break;
                            }
                            ...
                            AllTargets.Clear();
                            if (PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.ResetSequences"), false,
                                    PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No")))
                            {
                                Sequences.Clear();
                        ...
                        case Setting.MaxLength:
                            text = PickString.Show(PassionCommon.Localize("S3_Passion.Terms.MaxLength"),
                                PassionCommon.Localize("S3_Passion.Terms.MaxLengthText"),
                                PassionCommon.TicksToMinutes(Settings.MaxLength).ToString());
                            if (text != null)
                            {
                        ...
                        {
                            text = PickString.Show(PassionCommon.Localize("S3_Passion.Terms.Autonomy"),
                                PassionCommon.Localize("S3_Passion.Terms.AutonomyText"),
                                Settings.AutonomyChance.ToString());
                            if (text == null)
                            {
                                break;
                            }
                            ...
                            text = PickString.Show(PassionCommon.Localize("S3_Passion.Terms.AutonomyLength"),
                                PassionCommon.Localize("S3_Passion.Terms.AutonomyLengthText"),
                                PassionCommon.TicksToMinutes(Settings.AutonomyLength).ToString());
                            if (text != null)
                            {
                            ...
                            Settings.AutonomyPublic = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms.AutonomyPublicText"), Settings.AutonomyPublic,
                                PassionCommon.Localize("S3_Passion.Terms.Enabled"),
                                PassionCommon.Localize("S3_Passion.Terms.Disabled"));
                            Settings.AutonomyActive = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms.AutonomyActiveText"), Settings.AutonomyActive,
                                PassionCommon.Localize("S3_Passion.Terms.Enabled"),
                                PassionCommon.Localize("S3_Passion.Terms.Disabled"));
                            Settings.AutonomyNotify = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms.AutonomyNotifyText"), Settings.AutonomyNotify,
                                PassionCommon.Localize("S3_Passion.Terms.Enabled"),
                                PassionCommon.Localize("S3_Passion.Terms.Disabled"));
                            break;
                        }
                        case Setting.Eligibility:
                            Settings.Incest = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms.AllowNearRelation"), Settings.Incest,
                                PassionCommon.Localize("S3_Passion.Terms.Enabled"),
                                PassionCommon.Localize("S3_Passion.Terms.Disabled"));
                            if (PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.AllowTeen"), Settings.Teen,
                                    PassionCommon.Localize("S3_Passion.Terms.Enabled"),
                                    PassionCommon.Localize("S3_Passion.Terms.Disabled")))
                            {
                                Settings.Teen = true;
                        ...
                        case Setting.EndWhenFull:
                        {
                            ...
                            Settings.EndWhenFull = GenericDialog.Ask(optionList8,
                                PassionCommon.Localize("S3_Passion.Terms.EndWhenFull"));
                            break;
                        }
                        case Setting.ExludeInvalidPositions:
                            Settings.ExcludeInvalidPositions = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms.ExcludeInvalidPositionsText"),
                                Settings.ExcludeInvalidPositions, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                            break;
                        case Setting.VampireInteractions:
                            Settings.VampireInteractions = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms.VampireInteractions"),
                                Settings.VampireInteractions, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                            break;
                        case Setting.ChildrenOut:
                            Settings.ChildrenOut =
                                PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.ChildrenOut"),
                                    Settings.ChildrenOut, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No"));
                            break;
                        case Setting.PetsOut:
                            Settings.PetsOut = PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.PetsOut"),
                                Settings.PetsOut, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                            break;
                        case Setting.EldersOut:
                            Settings.EldersOut = PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.EldersOut"),
                                Settings.EldersOut, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                            break;
                        case Setting.VampiresVisitAtNight:
                            Settings.VampiresVisitAtNight = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms.VampiresVisitAtNight"),
                                Settings.VampiresVisitAtNight, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                            break;
                        case Setting.VampireHypnoSex:
                            Settings.VampireHypnoSex = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms.VampireHypnoSex"), Settings.VampireHypnoSex,
                                PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                            break;
                        case Setting.EvilFighter:
                            Settings.EvilFighter =
                                PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.EvilFighter"),
                                    Settings.EvilFighter, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No"));
                            break;
                        case Setting.RemoveVisualOverride:
                            Settings.RemoveVisualOverride = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms.RemoveVisualOverride"),
                                Settings.RemoveVisualOverride, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                            break;
                        case Setting.BroadCasterEnable:
                            Settings.BroadCasterEnable = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms. BroadCasterEnableText"),
                                Settings.BroadCasterEnable, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                            break;
                        case Setting.FemaleUseStrapOn:
                            Settings.FemaleUseStrapOn = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms.FemaleUseStrapOnText"),
                                Settings.FemaleUseStrapOn, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                            Settings.ExcludeInvalidPositions = false;
                            ReloadDefaultPositions();
                            break;
                        case Setting.StripperAutonomy:
                            Settings.StripperAutonomy = PickBoolean.Show(
                                PassionCommon.Localize("S3_Passion.Terms.StripperAutonomyText"),
                                Settings.StripperAutonomy, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                            break;
                        case Setting.Jealousy:
                            Settings.Jealousy =
                                PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.JealousyText"),
                                    Settings.Jealousy, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No"));
                            if (Settings.Jealousy)
                            {
                                Settings.PolyamorousJealousy = PickBoolean.Show(
                                    PassionCommon.Localize("S3_Passion.Terms.PolyamorousJealousyText"),
                                    Settings.PolyamorousJealousy, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No"));
                            }
                        ...
                        case Setting.Label:
                        {
                            string text7 = PickString.Show(PassionCommon.Localize("S3_Passion.Terms.PassionLabel"),
                                PassionCommon.Localize("S3_Passion.Terms.PassionLabelText"), Settings.Label);
                            ...
                            string text8 =
                                PickString.Show(PassionCommon.Localize("S3_Passion.Terms.PassionActiveLabel"),
                                    PassionCommon.Localize("S3_Passion.Terms.PassionActiveLabelText"),
                            ...
                            string text9 = PickString.Show(PassionCommon.Localize("S3_Passion.Terms.PassionSoloLabel"),
                                PassionCommon.Localize("S3_Passion.Terms.PassionSoloLabelText"), Settings.SoloLabel);
                        ...
                        {
                            bool flag12 = PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.LibidoBuffText"),
                                Settings.LibidoBuff, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                            ...
                            bool flag13 = PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.WoohooBuffText"),
                                Settings.WoohooBuff, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                PassionCommon.Localize("S3_Passion.Terms.No"));
                        ...
                        case Setting.RelationshipGain:
                        {
                            ...
                            Settings.RelationshipGain = GenericDialog.Ask(optionList16,
                                PassionCommon.Localize("S3_Passion.Terms.RelationshipGainText"));
                            break;
                        }
                        case Setting.CanReject:
                            if (PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.CanRejectText"),
                                    Settings.CanReject, PassionCommon.Localize("S3_Passion.Terms.Enabled"),
                                    PassionCommon.Localize("S3_Passion.Terms.Disabled")))
                            {
                                Settings.ActiveAlwaysAccepts = PickBoolean.Show(
                                    PassionCommon.Localize("S3_Passion.Terms.ActiveAlwaysAccepts"),
                                    Settings.ActiveAlwaysAccepts, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No"));
                                ...
                                Settings.RelationshipLoss = GenericDialog.Ask(optionList13,
                                    PassionCommon.Localize("S3_Passion.Terms.RelationshipLossText"));
                            }
                            else
                            {
                        ...
                        case Setting.GetHard:
                            Settings.GetHard =
                                PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.HardBeforeText"),
                                    Settings.GetHard, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No"));
                            Settings.GetSoft =
                                PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.SoftAfterText"),
                                    Settings.GetSoft, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No"));
                            if (Settings.GetSoft)
                            {
                                Settings.StrapOnMode = PickBoolean.Show(
                                    PassionCommon.Localize("S3_Passion.Terms.StrapOnMode"), Settings.StrapOnMode,
                                    PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No"));
                            }
                        ...
                        {
                            GenericDialog.OptionList<PregnancyMethod> optionList17 =
                                new GenericDialog.OptionList<PregnancyMethod>();
                            optionList17.Add(
                                PassionCommon.Localize("S3_Passion.Terms.Enabled") + " (" +
                                PassionCommon.Localize("S3_Passion.Terms.Category") + ")", PregnancyMethod.ByCategory);
                            optionList17.Add(
                                PassionCommon.Localize("S3_Passion.Terms.Enabled") + " (" +
                                PassionCommon.Localize("S3_Passion.Terms.Position") + ")", PregnancyMethod.ByPosition);
                            optionList17.Add(
                                PassionCommon.Localize("S3_Passion.Terms.Enabled") + " (" +
                                PassionCommon.Localize("S3_Passion.Terms.KWSystem") + ")", PregnancyMethod.KwSystem);
                            optionList17.Add(PassionCommon.Localize("S3_Passion.Terms.Disabled"),
                                PregnancyMethod.Disabled);
                            Settings.PregnancyMethod = GenericDialog.Ask(optionList17,
                                PassionCommon.Localize("S3_Passion.Terms.Pregnancy"));
                            if (Settings.PregnancyMethod != 0)
                            {
                                // mpreg settings
                                // look into this later to add lesbian pregnancy too
                                Settings.PregnancyMale = PickBoolean.Show(
                                    PassionCommon.Localize("S3_Passion.Terms.MaleMale"), Settings.PregnancyMale,
                                    PassionCommon.Localize("S3_Passion.Terms.Enabled"),
                                    PassionCommon.Localize("S3_Passion.Terms.Disabled"));
                                text = PickString.Show(PassionCommon.Localize("S3_Passion.Terms.PregnancyRisk"),
                                    PassionCommon.Localize("S3_Passion.Terms.PregnancyRiskText"),
                                    Settings.PregnancyRisk.ToString());
                                if (text != null)
                                {
                        ...
                        case Setting.UseCondom:
                            ...
                            {
                                Settings.UseCondom = PickBoolean.Show(
                                    PassionCommon.Localize("S3_Passion.Terms.UseCondom"), Settings.UseCondom,
                                    PassionCommon.Localize("S3_Passion.Terms.Enabled"),
                                    PassionCommon.Localize("S3_Passion.Terms.Disabled"));
                                if (!Settings.UseCondom)
                                {
                                ...
                                text = PickString.Show(PassionCommon.Localize("S3_Passion.Terms.CondomBrakeChance"),
                                    PassionCommon.Localize("S3_Passion.Terms.CondomBrakeChanceText"),
                                    Settings.CondomBrakeChance.ToString());
                                if (text != null)
                                {
                            ...
                            {
                                Settings.UseCondom = false;
                                PassionCommon.SystemMessage(PassionCommon.Localize(
                                    "Pregnancy and STDs settings are\r disabled! There's no need for condoms."));
                            }
                            else if (Settings.PregnancyMethod != PregnancyMethod.KwSystem &&
                                     Settings.PregnancyMethod != 0)
                            {
                                Settings.UseCondom = false;
                                PassionCommon.SystemMessage(PassionCommon.Localize(
                                    "Use Condoms Setting works only with \r -Passion Choice- Pregnancy Setting."));
                            }
                        ...
                        case Setting.Std:
                        {
                            ...
                            bool flag11 = GenericDialog.Ask(optionList14,
                                PassionCommon.Localize("S3_Passion.Terms.STDs"));
                            if (flag11)
                            {
                                GenericDialog.OptionList<StdImmunity> optionList15 =
                                    new GenericDialog.OptionList<StdImmunity>();
                                optionList15.Add(PassionCommon.Localize("S3_Passion.Terms.Immunity"),
                                    StdImmunity.Immune);
                                optionList15.Add(PassionCommon.Localize("S3_Passion.Terms.Resistance"),
                                    StdImmunity.Resistant);
                                optionList15.Add(PassionCommon.Localize("S3_Passion.Terms.NoEffect"),
                                    StdImmunity.Vulnerable);
                                Settings.StdSimmunity = GenericDialog.Ask(optionList15,
                                    PassionCommon.Localize("S3_Passion.Terms.STDSimmunityEffect"));
                            }

                            if (flag11 && !Settings.Std)
                            {
                                S3_Passion.Std.AddRandomToAll();
                            }
                        ...
                        case Setting.Outfit:
                        {
                            GenericDialog.OptionList<OutfitCategories> optionList12 =
                                new GenericDialog.OptionList<OutfitCategories>();
                            optionList12.Add(PassionCommon.Localize("S3_Passion.Terms.Naked"), OutfitCategories.Naked);
                            optionList12.Add(PassionCommon.Localize("S3_Passion.Terms.Sleepwear"),
                                OutfitCategories.Sleepwear);
                            optionList12.Add(PassionCommon.Localize("S3_Passion.Terms.PreferredOnly"),
                                OutfitCategories.None);
                            Settings.Outfit = GenericDialog.Ask(optionList12,
                                PassionCommon.Localize("S3_Passion.Terms.WhichOutfit"));
                            if (Settings.Outfit != OutfitCategories.Naked)
                            {
                                Settings.NakedShower = PickBoolean.Show(
                                    PassionCommon.Localize("S3_Passion.Terms.NakedShower"), Settings.NakedShower,
                                    PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No"));
                            }
                        ...
                        {
                            GenericDialog.OptionList<PassionMotives> optionList11 =
                                new GenericDialog.OptionList<PassionMotives>();
                            optionList11.Add(PassionCommon.Localize("S3_Passion.Terms.EADefault"),
                                PassionMotives.EaDefault);
                            optionList11.Add(PassionCommon.Localize("S3_Passion.Terms.PassionStandard"),
                                PassionMotives.PassionStandard);
                            optionList11.Add(PassionCommon.Localize("S3_Passion.Terms.NoDecay"),
                                PassionMotives.NoDecay);
                            ...
                            Settings.Motives = GenericDialog.Ask(optionList11,
                                PassionCommon.Localize("S3_Passion.Terms.MotiveSatisfaction"));
                            break;
                        }
                        case Setting.InitialCategory:
                        {
                            ...
                            Settings.InitialCategory = GenericDialog.Ask(optionList10,
                                PassionCommon.Localize("S3_Passion.Terms.InitialCategory"));
                            break;
                        }
                        case Setting.Positions:
                        {
                            ...
                            while (flag10)
                            {
                                ...
                                optionList9.Add(PassionCommon.Localize("S3_Passion.Terms.AddPosition"),
                                    PassionCommon.Localize("S3_Passion.Terms.AddPosition"));
                                optionList9.Add(PassionCommon.Localize("S3_Passion.Terms.ReloadDefaults"),
                                    PassionCommon.Localize("S3_Passion.Terms.ReloadDefaults"));
                                foreach (string xMlFile in XmlFiles)
                                {
                                    ...
                                    if (num8 != 0)
                                    {
                                        ...
                                        optionList9.Add(
                                            "\n" + xMlFile + " " + text10 + " " + num8.ToString().Trim() + "\r",
                                            xMlFile);
                                    }
                                }

                                string text11 = GenericDialog.Ask(optionList9,
                                    PassionCommon.Localize("Positions Found ") + ": " + Positions.Count, true);
                                if (text11 == PassionCommon.Localize("S3_Passion.Terms.AddPosition"))
                                {
                                    string text12 = PickString.Show(
                                        PassionCommon.Localize("S3_Passion.Terms.AddPositionFile"),
                                        PassionCommon.Localize("S3_Passion.Terms.AddPositionFileText"), string.Empty);
                                ...
                                {
                                    if (PickBoolean.Show(
                                            PassionCommon.Localize("S3_Passion.Terms.DeleteConfirm1") + text11 +
                                            PassionCommon.Localize("S3_Passion.Terms.DeleteConfirm2"), false,
                                            PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                            PassionCommon.Localize("S3_Passion.Terms.No")))
                                    {
                        ...
                        {
                            GenericDialog.OptionList<RandomizationOptions> optionList7 =
                                new GenericDialog.OptionList<RandomizationOptions>();
                            optionList7.Add(PassionCommon.Localize("S3_Passion.Terms.Positions"),
                                RandomizationOptions.Positions);
                            optionList7.Add(PassionCommon.Localize("S3_Passion.Terms.Sequences"),
                                RandomizationOptions.Sequences);
                            optionList7.Add(PassionCommon.Localize("S3_Passion.Terms.Both"),
                                RandomizationOptions.PositionsAndSequences);
                            Settings.RandomizationOptions = GenericDialog.Ask(optionList7,
                                PassionCommon.Localize("S3_Passion.Terms.RandomizationOptions"));
                            if (PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.RandomizationSameCategory"),
                                    true, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No")))
                            {
                                Settings.RandomizationOptions |= RandomizationOptions.SameCategory;
                            }

                            if (PickBoolean.Show(PassionCommon.Localize("S3_Passion.Terms.RandomizationLengthPrompt"),
                                    true, PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                    PassionCommon.Localize("S3_Passion.Terms.No")))
                            {
                                string text6 = PickString.Show(PassionCommon.Localize("S3_Passion.Terms.Randomization"),
                                    PassionCommon.Localize("S3_Passion.Terms.RandomizationLength"),
                                    PassionCommon.TicksToMinutes(Settings.RandomizationLength).ToString());
                                if (text6 != null)
                                {
                        ...
                        case Setting.Sequences:
                        {
                            ...
                            while (flag2)
                            {
                                GenericDialog.OptionList<Sequence.DialogEntry> optionList3 =
                                    new GenericDialog.OptionList<Sequence.DialogEntry>();
                                optionList3.Add(PassionCommon.Localize("S3_Passion.Terms.AddSequence"),
                                    Sequence.DialogEntry.Get(PassionCommon.Localize("S3_Passion.Terms.AddSequence"),
                                        null));
                                ...
                                Sequence.DialogEntry dialogEntry = GenericDialog.Ask(optionList3,
                                    PassionCommon.Localize("S3_Passion.Terms.Sequences"), true);
                                if (dialogEntry != null)
                                {
                                    bool flag3 = false;
                                    bool flag4 = false;
                                    ...
                                    {
                                        text = PickString.Show(PassionCommon.Localize("S3_Passion.Terms.NewSequence"),
                                            PassionCommon.Localize("S3_Passion.Terms.NewSequenceText"), string.Empty);
                                        if (text == null)
                                        {
                                            break;
                                        }
                                    ...
                                    else
                                    {
                                        ...
                                        switch (GenericDialog.Ask(optionList4,
                                                    PassionCommon.Localize("S3_Passion.Terms.SequenceEdit") + " \"" +
                                                    sequence.Name + "\"?"))
                                        {
                                            case 1:
                                                flag3 = true;
                                    ...
                                    else
                                    {
                                        ...
                                        while (flag5)
                                        {
                                            GenericDialog.OptionList<Sequence.DialogListItem> optionList5 =
                                                new GenericDialog.OptionList<Sequence.DialogListItem>();
                                            optionList5.Add(PassionCommon.Localize("S3_Passion.Terms.AddPosition"),
                                                Sequence.DialogListItem.Get(
                                                    PassionCommon.Localize("S3_Passion.Terms.AddPosition"), null));
                                            for (int i = 0; i < sequence.Items.Length; i++)
                                            {
                                                if (sequence.Items[i] != null)
                                                {
                                                    Position position = sequence.Items[i].Position;
                                                    string text5 = "(" + sequence.Items[i].Index + ") " +
                                                                   ((position != null)
                                                                       ? PassionCommon.Localize(position.Name)
                                                                       : sequence.Items[i].Key);
                                                    optionList5.Add(text5,
                                                        Sequence.DialogListItem.Get(text5, sequence.Items[i]));
                                                }
                                            }

                                            Sequence.DialogListItem dialogListItem = GenericDialog.Ask(optionList5,
                                                PassionCommon.Localize("S3_Passion.Terms.Editing") + " \"" +
                                                sequence.Name + "\"", true);
                                            if (dialogListItem != null)
                                            {
                                                ...
                                                {
                                                    GenericDialog.OptionList<int> optionList6 =
                                                        new GenericDialog.OptionList<int>();
                                                    optionList6.Add(
                                                        PassionCommon.Localize("S3_Passion.Terms.ChangePosition"), 1);
                                                    optionList6.Add(
                                                        PassionCommon.Localize("S3_Passion.Terms.ChangeLength"), 2);
                                                    optionList6.Add(PassionCommon.Localize("S3_Passion.Terms.MoveUp"),
                                                        3);
                                                    optionList6.Add(PassionCommon.Localize("S3_Passion.Terms.MoveDown"),
                                                        4);
                                                    optionList6.Add(PassionCommon.Localize("S3_Passion.Terms.Remove"),
                                                        5);
                                                    optionList6.Add(PassionCommon.Localize("S3_Passion.Terms.Cancel"),
                                                        0);
                                                    switch (GenericDialog.Ask(optionList6,
                                                                PassionCommon.Localize(sequenceItem.Position.Name)))
                                                    {
                                                        case 1:
                                                            flag7 = true;
                                                            break;
                                                ...
                                                {
                                                    Position position2 =
                                                        Position.ChooseSequencePositionDialog(sequence.SupportedTypes,
                                                            sequence.MinSims, sequence.MaxSims);
                                                    if (position2 != null)
                                                    {
                                                ...
                                                if (flag8)
                                                {
                                                    text = PickString.Show(
                                                        PassionCommon.Localize(sequenceItem.Position.Name),
                                                        PassionCommon.Localize("S3_Passion.Terms.SetLength"),
                                                        PassionCommon.TicksToMinutes(sequenceItem.Length).ToString());
                                                    if (text != null)
                                                    {
                                            ...
                                            sequence.Repeat = PickBoolean.Show(
                                                PassionCommon.Localize("S3_Passion.Terms.RepeatAll"), false,
                                                PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                                PassionCommon.Localize("S3_Passion.Terms.No"));
                                            if (!sequence.Repeat)
                                            {
                                                sequence.Continue = PickBoolean.Show(
                                                    PassionCommon.Localize("S3_Passion.Terms.ContinuePassion"), false,
                                                    PassionCommon.Localize("S3_Passion.Terms.Yes"),
                                                    PassionCommon.Localize("S3_Passion.Terms.No"));
                                            }
                        ...
                        case Setting.ExportImport:
                        {
                            ...
                            string text3 = GenericDialog.Ask(optionList2,
                                PassionCommon.Localize("S3_Passion.Terms.SettingsFile"));
                            if (text3 != null)
                            {
                                if (text3 == "Import")
                                {
                        ...
                        case Setting.ExportImportSequence:
                        {
                            ...
                            string text2 = GenericDialog.Ask(optionList,
                                PassionCommon.Localize("S3_Passion.Terms.Sequence.SettingsFile"));
                            if (text2 != null)
                            {
                                switch (text2)
                                {
            ...
            public static void Export(string name)
            {
                try
                {
                    ...
                    element2.AddChild("SoloLabel", Settings.SoloLabel);
            ...
            public static void Import(string name)
            {
                ...
                if (matchingNode != null)
                {
                    ...
                    Settings.RandomizationOptions =
                        (RandomizationOptions)PassionCommon.Int(matchingNode["RandomizationOptions"]);
...
*/
            ...
            public static void ImportSequence(string name)
            {
                ...
                foreach (Xml.Node matchingNode3 in matchingNode.GetMatchingNodes("Sequence"))
                {
                    ...
                    foreach (Sequence sequence2 in Sequences)
                    {
                        if (sequence2.Name != matchingNode3["Name"]) continue;
                        sequence = sequence2;
                        break;
                    }
...
*/
                ...
                try
                {
                    ...
                    if (Xml.WriteToPackage(element, name) && string.IsNullOrEmpty(name))
                    {
                        PassionCommon.SystemMessage(
                            PassionCommon.Localize("S3_Passion.Terms.Sequence.ExportSucceeded"));
                    }
                }
                catch
                {
        ...
        public class Xml
        {
            public class File
            {
                ...
                public Node this[string id]
                {
                    get
                    {
                        if (!IsValid || string.IsNullOrEmpty(id)) return null;
                ...
                {
                    if (key == ResourceKey.kInvalidResourceKey) return new File();
            ...
            public class Node
            {
                ...
                public bool IsValid
                {
                    get { return MHandle != null; }
                }

                public string Value
                {
                    get { return IsValid ? MHandle.InnerText : string.Empty; }
                }
                ...
                if (root != null)
                {
                    ...
                    if (string.IsNullOrEmpty(name))
                    {
                        ...
                        while (flag)
                        {
                            ...
                            {
                                flag = false;
                                text2 = PickString.Show(PassionCommon.Localize("S3_Passion.Terms.ExportFile"),
                                    PassionCommon.Localize("S3_Passion.Terms.ExportFileText"),
                                ...
                                foreach (IExportBinContents item in new List<IExportBinContents>(global::Sims3.Gameplay
                                             .BinModel.Singleton.ExportBinContents))
                                {
                                    if (item != null && !string.IsNullOrEmpty(item.HouseholdName) &&
                                        item.HouseholdName.ToLower() == name.ToLower())
                                    {
                    ...
                    {
                        global::Sims3.Gameplay.BinModel.Singleton.PopulateExportBin();
                        foreach (IExportBinContents item2 in new List<IExportBinContents>(global::Sims3.Gameplay
                                     .BinModel.Singleton.ExportBinContents))
                        {
                            if (item2 != null && !string.IsNullOrEmpty(item2.HouseholdName) &&
                                item2.HouseholdName.ToLower() == name.ToLower())
                            {
            ...
            public static File ReadFromPackage(string name)
            {
                if (string.IsNullOrEmpty(name))
                {
                    ...
                    {
                        global::Sims3.Gameplay.BinModel.Singleton.PopulateExportBin();
                        GenericDialog.OptionList<IExportBinContents> optionList =
                            new GenericDialog.OptionList<IExportBinContents>();
                        foreach (IExportBinContents item in new List<IExportBinContents>(global::Sims3.Gameplay.BinModel
                                     .Singleton.ExportBinContents))
                        {
                            if (item != null && item.HouseholdName != null &&
                                item.HouseholdName.StartsWith("PassionSettingsExport_"))
                            {
                                optionList.Add(item.HouseholdName.Replace("PassionSettingsExport_", string.Empty),
                                    item);
                            }
                        }
                        ...
                        {
                            flag2 = true;
                            IExportBinContents exportBinContents = GenericDialog.Ask(optionList,
                                PassionCommon.Localize("S3_Passion.Terms.ImportFile"), true);
                            ...
                            {
                                global::Sims3.Gameplay.BinModel.Singleton.DeleteFromExportBin(exportBinContents
                                    .ContentId);
                            }
                ...
                {
                    global::Sims3.Gameplay.BinModel.Singleton.PopulateExportBin();
                    foreach (IExportBinContents item2 in new List<IExportBinContents>(global::Sims3.Gameplay.BinModel
                                 .Singleton.ExportBinContents))
                    {
                        if (item2 != null && !string.IsNullOrEmpty(item2.HouseholdName) &&
                            item2.HouseholdName.ToLower() == name.ToLower())
                ...
                try
                {
                    if (root != null)
                    {
                        ...
                        if (fileHandle != 0)
                        {
                            ...
                            customXmlWriter.WriteToBuffer("<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
                                                          PassionCommon.NewLine);
        ...
        public class SectionalManager : IAlarmOwner
        {
            ...
            public static void TriggerUpdate()
            {
                ...
                {
                    UpdateAlarm = AlarmManager.Global.AddAlarm(2f, TimeUnit.Minutes, CheckSectionals,
                        "Sectional Furniture Check", AlarmType.NeverPersisted, Singleton);
                }
            }
                    ...
                    if (objects != null)
                    {
                        ...
                        foreach (ChairSectional chairSectional in array)
                        {
                            ...
                            else
                            {
                                ...
                                chairSectional.RemoveInteractionByType(
                                    Interactions.UseObjectForPassionWithSim.Singleton);
        ...
        public class Autonomy
        {
                    ...
                    try
                    {
                        ...
                        if (Settings.AutonomyChance > 0 && RandomUtil.GetInt(0, 99) < Settings.AutonomyChance)
                        {
                            ...
                            foreach (Sim allActor in sim.LotCurrent.GetAllActors())
                            {
                                ...
                                if (allActor != null && !allActor.LotCurrent.IsWorldLot &&
                                    (player.Actor.SimDescription.ChildOrBelow || !player.Actor.SimDescription.IsHuman))
                                {
                                    num--;
                                }
                            }
                            ...
                            if (Settings.AutonomyActive)
                            {
                                ...
                                if (player2.IsValid && !simDescription.ChildOrBelow && num >= 3 && num2 != 0 &&
                                    RandomUtil.CoinFlip())
                                {
                                    if (num2 <= 2)
                                    {
                                    ...
                                    {
                                        if (sim2.SimDescription.IsServicePerson && !(sim2.Service is Butler) &&
                                            !(sim2.Service is Maid))
                                        {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            if (sim3.SimDescription.TeenOrAbove && sim3.SimDescription.IsHuman &&
                                                !sim3.LotCurrent.IsWorldLot)
                                            {
                                    ...
                                    List<SculptureFloorGunShow> list2 =
                                        new List<SculptureFloorGunShow>(
                                            global::Sims3.Gameplay.Queries.GetObjects<SculptureFloorGunShow>(
                                                sim.LotCurrent, sim.RoomId));
                                    if (list2.Count > 0)
                                    {
                                    ...
                                    if (sim != null && gameObject != null && RandomUtil.CoinFlip() &&
                                        !sim.SimDescription.Elder &&
                                        sim.InteractionQueue.GetCurrentInteraction().InteractionDefinition !=
                                        StripperPole.WatchStrip.Singleton &&
                                        sim.InteractionQueue.GetCurrentInteraction().InteractionDefinition !=
                                        Interactions.UseObjectForPassion.Singleton &&
                                        sim.InteractionQueue.GetCurrentInteraction().InteractionDefinition !=
                                        Interactions.UseSimForPassion.Singleton &&
                                        sim.InteractionQueue.GetCurrentInteraction().InteractionDefinition !=
                                        Interactions.ActiveJoinPassion.Singleton &&
                                        sim.InteractionQueue.GetCurrentInteraction().InteractionDefinition !=
                                        Interactions.JoinPassion.Singleton &&
                                        sim.InteractionQueue.GetCurrentInteraction().InteractionDefinition !=
                                        Interactions.AskToJoinPassion.Singleton &&
                                        sim.InteractionQueue.GetCurrentInteraction().InteractionDefinition !=
                                        Interactions.AskToSoloPassion.Singleton &&
                                        sim.InteractionQueue.GetCurrentInteraction().InteractionDefinition !=
                                        Interactions.AskToPassionOther.Singleton &&
                                        sim.InteractionQueue.GetCurrentInteraction().InteractionDefinition !=
                                        Interactions.AskToWatchPassion.Singleton &&
                                        sim.InteractionQueue.GetCurrentInteraction().InteractionDefinition !=
                                        Interactions.WatchPassion.Singleton &&
                                        sim.InteractionQueue.GetCurrentInteraction().InteractionDefinition !=
                                        Interactions.WatchMasturbate.Singleton)
                                    {
                                        if (sim.SimDescription.IsServicePerson && !(sim.Service is Butler) &&
                                            !(sim.Service is Maid) &&
                                            sim.CurrentOutfitCategory != OutfitCategories.Career)
                                        {
                                        ...
                                        sim.InteractionQueue.AddAfterCheckingForDuplicates(
                                            StripperPole.AutoDance.Singleton.CreateInstance(gameObject, sim,
            ...
            public static ListenerAction WhenWatchTv(Event e)
            {
                ...
                if (World.ResourceExists(key) && World.ResourceExists(key2) && World.ResourceExists(key3) &&
                    World.ResourceExists(key4) && World.ResourceExists(key5) && World.ResourceExists(key6) &&
                    World.ResourceExists(key7) && World.ResourceExists(key8))
                {
                    try
                    {
                        if (Settings.AutonomyChance > 0 && RandomUtil.GetInt(0, 99) < Settings.AutonomyChance)
                        {
                            ...
                            if (TVChannelData.GetChannelNames(TVChannelLevel.Level1)
                                    .Contains("Gameplay/Excel/TV/TVChannel:Channel_1") &&
                                TVChannelData.GetChannelNames(TVChannelLevel.Level1)
                                    .Contains("Gameplay/Excel/TV/TVChannel:Channel_2") &&
                                TVChannelData.GetChannelNames(TVChannelLevel.Level1)
                                    .Contains("Gameplay/Excel/TV/TVChannel:Channel_3") &&
                                TVChannelData.GetChannelNames(TVChannelLevel.Level1)
                                    .Contains("Gameplay/Excel/TV/TVChannel:Channel_4") &&
                                (Settings.AutonomyActive || (sim.Household != Household.ActiveHousehold &&
                                ...
                                (Settings.AutonomyPublic || sim.LotCurrent.LotType == LotType.Residential))
                            {
                                ...
                                SimDescription simDescription = sim.SimDescription;
                                if (player.IsValid && !player.IsActive && !simDescription.ChildOrBelow &&
                                    (player.Actor.InteractionQueue.GetHeadInteraction().ToString() ==
                                     PassionCommon.Localize(
                                         "Gameplay/Objects/Electronics/TV/WatchTV:WatchTVInteractionName") ||
                                     player.Actor.InteractionQueue.GetHeadInteraction().ToString() ==
                                     PassionCommon.Localize(
                                         "Gameplay/Objects/Electronics/TV/WatchTVAutonomously:WatchTVInteractionName")))
                                {
                                    ...
                                    if (player.Actor.BuffManager.HasElement((BuffNames)2922253427052633003uL))
                                    {
                                        ...
                                        player.Actor.InteractionQueue.AddNext(
                                            Interactions.AutoSoloPassion.Singleton.CreateInstance(player.Actor,
                                                player.Actor,
            ...
            public static ListenerAction PassionCheck(Event e)
            {
                try
                {
                    ...
                    if (Settings.AutonomyChance > 0 && RandomUtil.GetInt(0, 99) < Settings.AutonomyChance)
                    {
                        Sim sim = e.Actor as Sim;
                        Sim sim2 = e.TargetObject as Sim;
                        if (!(sim.Posture is RelaxingPosture) && !(sim.Posture is SittingPosture) &&
                            Player.CanPassion(sim, sim2) && Player.WillPassion(sim, sim2) &&
                            Player.WillPassion(sim2, sim) &&
                            (Settings.AutonomyActive || (sim.Household != Household.ActiveHousehold &&
                                                         sim2.Household != Household.ActiveHousehold)) &&
                            (Settings.AutonomyPublic || sim.LotCurrent.LotType == LotType.Residential))
                        {
                            ...
                            if (player.IsValid && player2.IsValid && !player.IsActive && !player2.IsActive)
                            {
                                ...
                                if (passionCheckRoll > 0 && RandomUtil.GetInt(0, 100) > passionCheckRoll)
                                {
                                    ...
                                    if (target != null && target.IsValid)
                                    {
                                        ...
                                        {
                                            part = RandomUtil.GetRandomObjectFromList(
                                                new List<Part>(target.Parts.Values));
                                        }
                                        ...
                                        if (part != null && player.Join(part))
                                        {
                                            ...
                                            player.Actor.InteractionQueue.CancelAllInteractions();
                                            player.Actor.InteractionQueue.AddNext(
                                                Interactions.AskToPassion.Singleton.CreateInstance(player2.Actor,
                                                    player.Actor,
                                            ...
                                            if (Settings.AutonomyNotify)
                                            {
                                                try
                                                {
                                                    StringBuilder stringBuilder =
                                                        new StringBuilder(
                                                            PassionCommon.Localize(
                                                                "S3_Passion.Terms.AutonomyNotifySimMessage"));
                                                    ...
                                                    PassionCommon.SimMessage(stringBuilder.ToString(), player.Actor,
                                                        player2.Actor);
                                                }
                                                catch
                                                {
                                    ...
                                    {
                                        PassionCommon.SystemMessage("No valid target found for Autonomy for " +
                ...
                try
                {
                    ...
                    foreach (Sim item in list2)
                    {
                        ...
                        if (relationship2 != null)
                        {
                            ...
                            {
                                SocialComponent.OnIWasCheatedOn(witness, item.SimDescription,
                                    player.Actor.SimDescription, JealousyLevel.High);
                                RomanceVisibilityState.PushAccuseSimOfBetrayal(witness, item);
                                continue;
                            }
                        }

                        if (!Settings.PolyamorousJealousy && item.Partner != null && item.Partner.CreatedSim != null &&
                            !list.Contains(item.Partner.CreatedSim) &&
                            witness.Genealogy.IsBloodRelated(item.Partner.Genealogy))
                        {
                            SocialComponent.OnSomeoneICareAboutWasCheatedOn(witness, item.Partner, item.SimDescription,
                                player.Actor.SimDescription, JealousyLevel.High);
                        }
                    }
                }
        ...
        public class Player
        {
            ...
            {
                get { return ActiveLeave && ActiveJoin; }
                set
                {
                    ActiveLeave = value;
                    ActiveJoin = value;
            ...
            {
                get { return Partner != null && Partner.IsValid; }
            }

            public bool IsValid
            {
                get { return Actor != null && !Actor.HasBeenDestroyed; }
            }
            ...
            {
                get { return State == PassionState.Stopping || State == PassionState.Leaving; }
            }

            public bool IsWatching
            {
                get { return State == PassionState.Watching; }
            }

            public bool IsSolo
            {
                get { return IsValid && IsActive && HasPart && Part.Players.Count == 1; }
            }
            ...
            public bool IsInValidObject
            {
                get
                {
                    return !(Actor.CurrentInteraction.Target is Sim) &&
                           Actor.CurrentInteraction.Target.IsActorUsingMe(Actor) &&
                           PassionType.IsSupported(Actor.CurrentInteraction.Target);
                }
            }
            ...
            public bool IsInMotiveDesperation
            {
                get
                {
                    if (IsValid && Actor.Motives != null && Actor.Motives.InMotiveDistress &&
                        (Settings.Motives == PassionMotives.EaDefault ||
                         Settings.Motives == PassionMotives.PassionStandard) &&
                        (Actor.Motives.GetValue(CommodityKind.Energy) < -90f ||
                         Actor.Motives.GetValue(CommodityKind.Bladder) < -90f ||
                         Actor.Motives.GetValue(CommodityKind.Hunger) < -90f ||
                         Actor.Motives.GetValue(CommodityKind.MermaidDermalHydration) < -90f ||
                         Actor.Motives.GetValue(CommodityKind.VampireThirst) < -90f ||
                         Actor.Motives.GetValue(CommodityKind.AlienBrainPower) < -90f))
                    {
                        return true;
                    }
            ...
            public bool IsTimedOut
            {
                get
                {
                    ...
                    {
                        if ((Settings.MaxLength > 0 && StartTime + Settings.MaxLength < SimClock.CurrentTicks) ||
                            (IsAutonomous && StartTime + Settings.AutonomyLength < SimClock.CurrentTicks))
                        {
                            return true;
                        }
            ...
            public bool IsFull
            {
                get
                {
                    if (Settings.EndWhenFull && IsValid && Settings.Motives != PassionMotives.Freeze &&
                        Actor.Motives.GetMotiveValue(CommodityKind.Fun) >= 100f &&
                        (!HadPartner || Actor.Motives.GetMotiveValue(CommodityKind.Social) >= 100f) && (!HasPart ||
                            !Part.HasTarget || !Part.Target.HasObject ||
                            (!(Part.Target.Object is IShowerable) && !(Part.Target.Object is IBathtub)) ||
                            Actor.Motives.GetMotiveValue(CommodityKind.Hygiene) >= 100f))
                    {
                        return true;
                    }
            ...
            {
                get { return SwitchPart != null; }
            }

            public bool HasCigarette
            {
                get { return PassionCommon.HasPart(Actor, SimPart.Cigarette); }
            }

            // if a sim has a penis made of MEAT
            public bool HasRealPenis
            {
                get { return IsValid && (IsTransfem || Actor.IsMale && !IsTransmasc); }
            }

            public bool HasVisiblePenis
            {
                get { return PassionCommon.HasPart(Actor, SimPart.Penis); }
            }

            // refactor eventually to include dudes with vaginas
            public bool HasVagina
            {
                get { return !HasRealPenis; }
            }

            public Sim.SwitchOutfitHelper SwitchOutfitHelper
            {
                get { return MSwitchOutfitHelper; }
                set
                {
            ...
            {
                if (IsValid && !Actor.IsSimBot && !Actor.IsEP11Bot &&
                    (index != Actor.CurrentOutfitIndex || category != Actor.CurrentOutfitCategory))
                {
            ...
            public void GetHard()
            {
                if (IsValid)
                {
                    SimPart.Types.Penis.GetHard(Actor);
                }
            }
            ...
            public void GetSoft()
            {
                if (IsValid)
                {
                    SimPart.Types.Penis.GetSoft(Actor);
                }
            }
            ...
            public static bool WillPassion(Sim sim, Sim[] targets)
            {
                ...
                foreach (Sim target in targets)
                {
                    if (WillPassion(sim, target))
                    {
                        return true;
                    }
                }
            ...
            // modify this to include multipliers for new libido system
            public static bool WillPassion(Sim sim, Sim target)
            {
                ...
                int num2 = 0;
                Relationship relationship = sim.GetRelationship(target, false);
                if (relationship != null)
                {
                ...
                if (target.HasTrait(TraitNames.Flirty))
                {
                    num2 += 5;
                }
                else if (target.HasTrait(TraitNames.Unflirty))
                {
                    num2 -= 10;
                }
            
                if (target.HasTrait(TraitNames.Attractive))
                {
                    num2 += 10;
                }
            
                if (GameUtils.IsInstalled(ProductVersion.EP1) && target.HasTrait(TraitNames.EyeCandy))
                {
                    num2 += 20;
                }
            
                if (GameUtils.IsInstalled(ProductVersion.EP9) && target.HasTrait(TraitNames.Irresistible))
                {
                    num2 += 40;
                }
            
                if (GameUtils.IsInstalled(ProductVersion.EP3) && target.HasTrait(TraitNames.MasterOfSeduction))
                {
                    num2 += 100;
                }
            
                BuffManager buffManager = sim.BuffManager;
                if (buffManager.HasElement((BuffNames)10626820509964641423uL) ||
                    buffManager.HasElement((BuffNames)7244019685987188093uL))
                {
                    num2 += 5;
                }
                else if (buffManager.HasElement((BuffNames)16341761339885008577uL) ||
                         buffManager.HasElement((BuffNames)13910300093031145699uL))
                {
                    num2 += 10;
                }
                ...
                if (!sim.SimDescription.NotOpposedToRomanceWithGender(target.SimDescription.Gender) &&
                    !GetPlayer(target).IsTransfem)
                {
                    num2 -= 60;
                }
            
                num2 += Modules.GetPassionScoringModifier(sim, target);
            ...
            public void ImproveRelationships()
            {
                ...
                foreach (Player value in Part.Players.Values)
                {
                    if (value != null && value != this && !PartnersUpdated.Contains(value) &&
                        !value.PartnersUpdated.Contains(this))
                    {
            ...
            public void PlayRouteFailure()
            {
                if (IsValid)
                {
                    ThoughtBalloonManager.BalloonData balloonData =
                        new ThoughtBalloonManager.BalloonData("t_balloon_routefail");
            ...
            public void PlayJoinFailure(Sim unliked)
            {
                ...
                {
                    ThoughtBalloonManager.BalloonData balloonData =
                        new ThoughtBalloonManager.BalloonData(unliked.GetThumbnailKey());
            ...
            public GameObject GetNearbySupportedObject()
            {
                if (IsValid)
                {
                    ...
                    for (int i = 0; i < PassionCommon.PreferredTypes.Count; i++)
                    {
                        ...
                        GameObject[] array =
                            global::Sims3.SimIFace.Queries.GetObjects(randomObjectFromList, Actor.LotCurrent.LotId,
                                Actor.RoomId) as GameObject[];
                        if (array == null)
                        {
                            continue;
                        }
                    ...
                    GameObject[] objects =
                        global::Sims3.Gameplay.Queries.GetObjects<GameObject>(Actor.LotCurrent, Actor.RoomId);
                    ...
                    foreach (GameObject gameObject2 in array3)
                    {
                        if (gameObject2 != null && !gameObject2.HasBeenDestroyed)
                        {
                            ...
                            if (supportedType != null && !supportedType.Is<Windows>() &&
                                !supportedType.Is<ChairDining>() &&
                                !PassionCommon.PreferredTypes.Contains(supportedType.Type) && HasRoom(gameObject2))
                            {
                                return gameObject2;
                            }
                        }
            ...
            public bool Invite(Player partner, Interaction<Sim, Sim> interaction)
            {
                if (partner != null && partner.IsValid)
                {
                    ...
                    {
                        partner.Actor.InteractionQueue.CancelInteraction(
                            partner.Actor.InteractionQueue.GetCurrentInteraction(), true);
                    ...
                    InteractionInstance entry = (interaction.LinkedInteractionInstance =
                        Interactions.BeAskedToPassion.Singleton.CreateInstance(Actor, partner.Actor,
                            new InteractionPriority(InteractionPriorityLevel.High), false, true));
                    partner.Actor.InteractionQueue.Add(entry);
                    if (Actor.WaitForSynchronizationLevelWithSim(partner.Actor, Sim.SyncLevel.Started, 60f) &&
                        Route(partner))
                    {
                    ...
                    if (--PartnersToCheckCount < 1)
                    {
                        ...
                        else if (NumberAccepted > 0)
                        {
                            Actor.InteractionQueue.PushAsContinuation(
                                Interactions.RouteToPassion.Singleton.CreateInstance(partner.Actor, Actor,
            ...
            public void PlayInviteSuccess(Player partner)
            {
                ...
                {
                    animationName = ((!RandomUtil.CoinFlip())
                        ? "a2a_soc_Amorous_flirtHitOn_Amorous_Amorous_x"
                        : "a2a_soc_Neutral_RevealSecret_Friendly_Neutral_x");
                }
            ...
            public void PlayRespondSuccess(Player partner)
            {
                ...
                else if (GameUtils.IsInstalled(ProductVersion.EP3) &&
                         partner.Actor.HasTrait(TraitNames.MasterOfSeduction))
                {
                    if (GameUtils.IsInstalled(ProductVersion.EP9))
                    {
            ...
            public bool Route()
            {
                ...
                {
                    Actor.InteractionQueue.PushAsContinuation(
                        Interactions.BeginPassion.Singleton.CreateInstance(Actor, Actor,
                            new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), true);
                    return true;
                }
            ...
            public bool Route(Player partner, float range)
            {
                if (partner != null && partner.IsValid)
                {
                    Route.RouteOption[] additionalRouteOptions = new Route.RouteOption[1]
                        { global::Sims3.SimIFace.Route.RouteOption.MakeDynamicObjectAdjustments };
                    try
                    {
                        if (Actor.RoutingComponent.RouteToObjectRadialRange(partner.Actor, 1.5f, range,
            ...
            public bool RouteToTarget()
            {
                if (IsValid && HasPart && Part.HasTarget)
                {
                    ...
                    if (Part.Target.HasObject)
                    {
                        ...
                        {
                            if (Actor.RouteToPointRadialRange(
                                    Part.Target.Object.GetPositionOfSlot(Door.RoutingSlots.Door0_Front), 0.1f, 1.5f))
                            {
                                return true;
                            }

                            if (Actor.RouteToPointRadialRange(
                                    Part.Target.Object.GetPositionOfSlot(Door.RoutingSlots.Door0_Front), 0.1f, 3f))
                            {
                                return true;
                            }
                        }
                        ...
                        {
                            if (Actor.RouteToPointRadialRange(Part.Target.Object.GetPositionOfSlot((Slot)1986264130u),
                                    0.1f, 1.5f))
                            {
                                return true;
                            }
                        ...
                        try
                        {
                            if (Actor.RoutingComponent.RouteToObjectRadialRange(Part.Target.Object, 0.5f, 2.5f,
                                    additionalRouteOptions))
                            {
                                return true;
                            }
                        ...
                        try
                        {
                            if (Actor.RoutingComponent.RouteToObjectRadialRange(Part.Target.Object, 0.5f, 5f,
                                    additionalRouteOptions))
                            {
                                return true;
                            }
            ...
            public bool RouteInWater(Vector3 point, float min, float max, float spacing)
            {
                if (point != Vector3.Invalid && point != Vector3.Empty)
                {
                    ...
                    route.SetOption(
                        global::Sims3.SimIFace.Route.RouteOption.DoNotEmitDegenerateRoutesForRadialRangeGoals, true);
            ...
            public void BeginMotiveUpdates()
            {
                ...
                else
                {
                    ...
                    if (num != 0f || flag)
                    {
                        currentInteraction.BeginCommodityUpdate(
                            new CommodityChange(CommodityKind.Fun, num, false, num, OutputUpdateType.First, false, true,
                                UpdateAboveAndBelowZeroType.Either), 1f);
                    }

                    if (num2 != 0f || flag)
                    {
                        currentInteraction.BeginCommodityUpdate(
                            new CommodityChange(CommodityKind.Hygiene, num2, false, num2, OutputUpdateType.First, false,
                                true, UpdateAboveAndBelowZeroType.Either), 1f);
                    }

                    if (num3 != 0f || flag)
                    {
                        currentInteraction.BeginCommodityUpdate(
                            new CommodityChange(CommodityKind.Bladder, num3, false, num3, OutputUpdateType.First, false,
                                true, UpdateAboveAndBelowZeroType.Either), 1f);
                    }
                    ...
                    {
                        currentInteraction.BeginCommodityUpdate(
                            new CommodityChange(CommodityKind.Hunger, num4, false, num4, OutputUpdateType.First, false,
                                true, UpdateAboveAndBelowZeroType.Either), 1f);
                    }
                    ...
                    {
                        currentInteraction.BeginCommodityUpdate(
                            new CommodityChange(CommodityKind.Energy, num5, false, num5, OutputUpdateType.First, false,
                                true, UpdateAboveAndBelowZeroType.Either), 1f);
                    }
                    ...
                    {
                        currentInteraction.BeginCommodityUpdate(
                            new CommodityChange(CommodityKind.Social, num6, false, num6, OutputUpdateType.First, false,
                                true, UpdateAboveAndBelowZeroType.Either), 1f);
                    }
                }
            }
            ...
            public void EndMotiveUpdates()
            {
                ...
                {
                    InteractionInstance currentInteraction = Actor.CurrentInteraction;
                    if (currentInteraction != null && Settings.Motives != 0 &&
                        Settings.Motives != PassionMotives.MaxAll)
                    {
            ...
            public void BroadcastPassionStart()
            {
                try
                {
                    ...
                    {
                        if (allActor == null || allActor.RoomId != Actor.RoomId ||
                            (allActor.CurrentInteraction != null && allActor.CurrentInteraction.Target is RabbitHole) ||
                            allActor.SimDescription.ChildOrBelow || allActor.SimDescription.IsPet ||
                            !CanPassion(allActor))
                        {
                            continue;
                        }
                        ...
                        if (player.Actor.HasTrait(TraitNames.PartyAnimal))
                        {
                            ...
                            player.Actor.InteractionQueue.AddNext(Interactions.Embarrassed.Singleton.CreateInstance(
                                Actor, allActor, new InteractionPriority(InteractionPriorityLevel.Privacy), true,
                                true));
                            ...
                            {
                                PassionCommon.SimMessage(
                                    PassionCommon.Localize("WOOOOOO YEAH!! You guys know how to PARTY HARD! LITERALLY!")
                                        .ToString(), player.Actor);
                            }
                        }
                        ...
                        else if (player.Actor.HasTrait(TraitNames.Flirty))
                        {
                            ...
                            {
                                PassionCommon.SimMessage(
                                    PassionCommon.Localize("Ooh la la! Who could deny such a show?").ToString(),
                                    player.Actor);
                            }
                        }
                        ...
                        else if (player.Actor.HasTrait(TraitNames.Daredevil))
                        {
                            ...
                            {
                                PassionCommon.SimMessage(
                                    PassionCommon.Localize("Livin' it on the edge, huh? Cheers, bro!").ToString(),
                                    player.Actor);
                            }
                        }
                        // if witness is diva
                        else if (GameUtils.IsInstalled(ProductVersion.EP6) && player.Actor.HasTrait(TraitNames.Diva))
                        {
                            ...
                            {
                                PassionCommon.SimMessage(
                                    PassionCommon.Localize("Wow, what a bold move...! I'm so intrigued...!").ToString(),
                                    player.Actor);
                            }
                        }
                        // general reactions
                        else if (Settings.AutonomyChance > 0 &&
                                 (Settings.AutonomyActive || !player.Actor.LotHome.IsActive) &&
                                 (Settings.AutonomyPublic || player.Actor.LotCurrent.LotType == LotType.Residential) &&
                                 RandomUtil.GetInt(0, 99) < Settings.AutonomyChance)
                        {
                            player.IsAutonomous = true;
                            player.Actor.InteractionQueue.AddNext(Interactions.WatchLoop.Singleton.CreateInstance(Actor,
                                player.Actor, new InteractionPriority(InteractionPriorityLevel.UserDirected), false,
                                true));
                            ...
                            if (Settings.AutonomyNotify && RandomUtil.CoinFlip())
                            {
                                ...
                                {
                                    PassionCommon.SimMessage(
                                        PassionCommon.Localize("Um... could you people get a room?").ToString(),
                                        player.Actor);
                                }
                                ...
                                {
                                    PassionCommon.SimMessage(
                                        PassionCommon.Localize("Stop that right now! That's too freaky for here!")
                                            .ToString(), player.Actor);
                                }
                                ...
                                {
                                    PassionCommon.SimMessage(
                                        PassionCommon.Localize("Boo! Boooooo! Cut it out!").ToString(), player.Actor);
                                }

                                if (PassionCommon.RandomReactionNeg == ReactionTypes.Inappropriate)
                                {
                                    PassionCommon.SimMessage(
                                        PassionCommon.Localize("Ergh, no thanks. Do that somewhere else.").ToString(),
                                        player.Actor);
                                }
                                ...
                                {
                                    PassionCommon.SimMessage(
                                        PassionCommon.Localize("Is this seriously happening?! Here? In PUBLIC?!")
                                            .ToString(), player.Actor);
                                }
                                ...
                                {
                                    PassionCommon.SimMessage(
                                        PassionCommon.Localize("What the hell?! I'm gonna be sick...").ToString(),
                                        player.Actor);
                                }
                            }
                ...
                try
                {
                    ...
                    foreach (Sim allActor in Actor.LotCurrent.GetAllActors())
                    {
                        ...
                        else if (GameUtils.IsInstalled(ProductVersion.EP6) && player.Actor.HasTrait(TraitNames.Diva))
                        {
                            ...
                            {
                                PassionCommon.SimMessage(
                                    PassionCommon.Localize("Wow, what a bold move...! I'm so intruiged...!").ToString(),
                                    player.Actor);
                            }
                        }
                        // general reactions
                                 ...
                                 RandomUtil.GetInt(0, 99) < Settings.AutonomyChance)
                        {
                            ...
                            if (Settings.AutonomyNotify && RandomUtil.CoinFlip())
                            {
                                ...
                                {
                                    PassionCommon.SimMessage(
                                        PassionCommon.Localize("Stop it!! That's too freaky for here!").ToString(),
                                        player.Actor);
                                }
            ...
            public void StartJealousyBroadcast()
            {
                ...
                {
                    JealousyBroadcaster =
                        new ReactionBroadcaster(Actor, Conversation.ReactToSocialParams, Autonomy.JealousyCheck);
                }
            }
            ...
            public bool ForceStartLoopImmediate()
            {
                if (IsValid)
                {
                    ...
                    Actor.InteractionQueue.AddNext(Interactions.BeginPassion.Singleton.CreateInstance(Actor, Actor,
            ...
            public bool StartLoop()
            {
                if (IsValid && HasPart)
                {
                    ...
                    {
                        SaveOutfit();
                        if (Settings.NakedShower && HasPart && Part.HasTarget && Part.Target.HasObject &&
                            (Part.Target.Object is IShowerable || Part.Target.Object is IBathtub))
                        {
                            Outfit = OutfitCategories.Naked;
                        }
                    ...
                    Actor.InteractionQueue.PushAsContinuation(
                        Interactions.PassionLoop.Singleton.CreateInstance(Actor, Actor,
                            new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), true);
                    return true;
                }
            ...
            public string Animation2Obj(string anim)
            {
                ...
                if (anim.Contains("KW_L666_Kinky_Animations.a_L666_carmasutramakout_01") && Part.Type.Is("CarSports") &&
                    !Part.Type.Is("CarExpensive1") && !Part.Type.Is("CarExpensive2") && !Part.Type.Is("CarHatchback") &&
                    !Part.Type.Is("CarUsed1"))
                {
                    Settings.ObjectAnimation = "a_L666_carsports3";
                }
                else if (anim.Contains("KW_L666_Kinky_Animations.a_L666_carmasutracowgrl_01") &&
                         Part.Type.Is("CarSports") && !Part.Type.Is("CarExpensive1") &&
                         !Part.Type.Is("CarExpensive2") && !Part.Type.Is("CarHatchback") && !Part.Type.Is("CarUsed1") &&
                         !Part.Type.Is("BoatSpeedBoat"))
                {
                    Settings.ObjectAnimation = "a_L666_carsports4";
                }
                else if (anim.Contains("KW_L666_Kinky_Animations.a_L666_carmasutracowgrl_02") &&
                         Part.Type.Is("CarSports") && !Part.Type.Is("CarExpensive1") &&
                         !Part.Type.Is("CarExpensive2") && !Part.Type.Is("CarHatchback") && !Part.Type.Is("CarUsed1") &&
                         !Part.Type.Is("BoatSpeedBoat"))
                {
                ...
                else if (anim.Contains("KW_L666_Kinky_Animations.a_L666_carmasutracowgrl_03") &&
                         Part.Type.Is("CarSports") && !Part.Type.Is("CarExpensive1") &&
                         !Part.Type.Is("CarExpensive2") && !Part.Type.Is("CarHatchback") && !Part.Type.Is("CarUsed1") &&
                         !Part.Type.Is("BoatSpeedBoat"))
                {
                ...
                else if (anim.Contains("KW_L666_Kinky_Animations.a_L666_threesomecarfmf_01o") &&
                         Part.Type.Is("CarSports") && !Part.Type.Is("CarExpensive1") &&
                         !Part.Type.Is("CarExpensive2") && !Part.Type.Is("CarHatchback") && !Part.Type.Is("CarUsed1"))
                {
                    Settings.ObjectAnimation = "a_L666_threesomecarfmfcaranime";
                }
                else if (anim.Contains("KW_L666_Kinky_Animations.a_L666_threesomecarfmf_02o") &&
                         Part.Type.Is("CarSports") && !Part.Type.Is("CarExpensive1") &&
                         !Part.Type.Is("CarExpensive2") && !Part.Type.Is("CarHatchback") && !Part.Type.Is("CarUsed1"))
                {
                    Settings.ObjectAnimation = "a_L666_threesomecarfmfcaranime2";
                }
                else if (anim.Contains("KW_Amra72_Animations.a2a_(Am)Car_Blowjob_01") && Part.Type.Is("CarSports") &&
                         !Part.Type.Is("CarExpensive1") && !Part.Type.Is("CarExpensive2") &&
                         !Part.Type.Is("CarHatchback") && !Part.Type.Is("CarUsed1") && !Part.Type.Is("BoatSpeedBoat"))
                {
                    Settings.ObjectAnimation = "a_L666_carsports4";
                }
                else if (!anim.Contains("KW_L666_Kinky_Animations.a_L666_carmasutramakout_01") &&
                         !anim.Contains("KW_L666_Kinky_Animations.a_L666_carmasutracowgrl_01") &&
                         !anim.Contains("KW_L666_Kinky_Animations.a_L666_carmasutracowgrl_02") &&
                         !anim.Contains("KW_L666_Kinky_Animations.a_L666_carmasutracowgrl_03") &&
                         !anim.Contains("KW_L666_Kinky_Animations.a_L666_threesomecarfmf_01o") &&
                         !anim.Contains("KW_L666_Kinky_Animations.a_L666_threesomecarfmf_02o") &&
                         !anim.Contains("KW_Amra72_Animations.a2a_(Am)Car_Blowjob_01") &&
                         Part.Position.ObjectAnimation != null)
                {
            ...
            public bool DoLoop()
            {
                ...
                if (IsValid)
                {
                    ...
                    if (simDescription.GetOutfit(OutfitCategories.Naked, 0)
                            .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0xB25D1F4F442041E6")) !=
                        null ||
                        simDescription.GetOutfit(OutfitCategories.Naked, 0)
                            .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0x23697088F9BC3EA8")) !=
                        null || simDescription.GetOutfit(OutfitCategories.Naked, 0)
                            .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0x49CBFB1B775EC86E")) != null)
                    {
                    ...
                    while (IsValid && HasPart)
                    {
                        ...
                        try
                        {
                            foreach (Sim allActor in Actor.LotCurrent.GetAllActors())
                            {
                                Player player = GetPlayer(allActor);
                                if (allActor != null && allActor.RoomId == Actor.RoomId &&
                                    !Actor.LotCurrent.IsWorldLot && !allActor.SimDescription.IsServicePerson &&
                                    allActor != Actor && (allActor.SimDescription.ChildOrBelow ||
                                                          allActor.SimDescription.IsPet || (allActor != Actor &&
                                                              allActor.SimDescription.Elder &&
                                                              Settings.AutonomyChance > 0)))
                                {
                                    if (allActor.InteractionQueue.Count <= 1 && Settings.ChildrenOut &&
                                        allActor.SimDescription.ChildOrBelow)
                                    {
                                        allActor.PlayReaction(ReactionTypes.Embarrassed, Actor,
                                            ReactionSpeed.Immediate);
                                        allActor.InteractionQueue.AddNext(
                                            Interactions.Embarrassed.Singleton.CreateInstance(Actor, allActor,
                                                new InteractionPriority(InteractionPriorityLevel.Privacy), true, true));
                                    }
                                    else if (allActor.InteractionQueue.Count <= 1 && Settings.PetsOut &&
                                             allActor.SimDescription.IsPet)
                                    {
                                        allActor.PlayReaction(ReactionTypes.Embarrassed, Actor,
                                            ReactionSpeed.Immediate);
                                        allActor.InteractionQueue.AddNext(
                                    ...
                                    else if (allActor.InteractionQueue.Count <= 1 && Settings.EldersOut &&
                                             allActor.SimDescription.Elder)
                                    {
                                        allActor.PlayReaction(ReactionTypes.Embarrassed, Actor,
                                            ReactionSpeed.Immediate);
                        ...
                        if (ShouldStop)
                        {
                            ...
                            try
                            {
                                ...
                                else if (Partner.Actor.IsFemale)
                                {
                                    SwitchToStrapon(Partner.Actor, false);
                                }
                            ...
                            try
                            {
                                ...
                                foreach (Sim allActor2 in Actor.LotCurrent.GetAllActors())
                                {
                                    ...
                                    if ((allActor2 != null && allActor2.RoomId == Actor.RoomId) ||
                                        (allActor2 != null && allActor2.RoomId == Partner.Actor.RoomId))
                                    {
                        ...
                        if (IsInitiator && Part.CanAnimate(out ready) && Part.CheckSequence())
                        {
                            try
                            {
                                if (SwitchPlayerActor != null && SwitchPlayerActor == Actor &&
                                    SwitchPlayerPartner != null && SwitchPlayerPartner == Partner.Actor)
                                {
                            ...
                            if (Part.Players.Count != Part.Position.MaxSims &&
                                Part.Position.MaxSims.ToString() != null && Part.Position.MaxSims == 0)
                            {
                                Part.Position.MaxSims = 1;
                            }
                            else
                            {
                                if (Part.Position.MaxSims.ToString() == null || Part.Position.MaxSims == 0 ||
                                    Part.Position == null)
                                {
                                    break;
                                }
                                ...
                                if (Part.Players.Count == 1 && Part.Position.MaxSims == 1)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (Actor.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !Actor.SimDescription.IsPregnant &&
                                            simDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[1])
                                        {
                                            SwitchToStrapon(Actor, true);
                                        }
                                        // gonna be real idfk what this check is
                                        else if (Actor.IsFemale && Settings.FemaleUseStrapOn &&
                                                 !Actor.SimDescription.IsPregnant &&
                                                 simDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                     .GetPartPreset(
                                                         ResourceKey.FromString(
                                        ...
                                        if (Actor.IsMale && Part.Position.Creator == "SM" &&
                                            Actor.SimDescription.YoungAdultOrAdult &&
                                            simDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x0603B3F0BE3C7883")) == null)
                                        {
                                            SwitchToPeener(Actor, true);
                                        }
                                        else if (simDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                     .GetPartPreset(
                                                         ResourceKey.FromString(
                                                             "0x034AEECB-0x00000000-0x0603B3F0BE3C7883")) != null)
                                        {
                                ...
                                else if (Part.Players.Count == 2 && Part.Position.MaxSims == 2)
                                {
                                    ...
                                    {
                                        // WHERE AM I
                                        if (Part.Position.Creator != "SM" &&
                                            simDescription3.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x0603B3F0BE3C7883")) != null)
                                        {
                                        ...
                                        if (Part.Position.Creator != "SM" &&
                                            simDescription4.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x0603B3F0BE3C7883")) != null)
                                        {
                                            SwitchToPeener(sim2, false);
                                        }

                                        if (sim.IsFemale && Settings.FemaleUseStrapOn &&
                                            !Part.Position.PutOnStraOn[1] && sim.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        {
                                        ...
                                        if (sim2.IsFemale && Settings.FemaleUseStrapOn &&
                                            !Part.Position.PutOnStraOn[2] && sim2.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim.SimDescription.IsPregnant &&
                                            sim.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[1])
                                        ...
                                        if (sim2.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim2.SimDescription.IsPregnant &&
                                            sim2.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[2])
                                        {
                                        ...
                                        if (sim.IsMale && Part.Position.Creator == "SM" &&
                                            sim.SimDescription.YoungAdultOrAdult && simDescription3
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x0603B3F0BE3C7883")) == null)
                                        ...
                                        else if (sim2.IsMale && Part.Position.Creator == "SM" &&
                                                 sim2.SimDescription.YoungAdultOrAdult &&
                                                 simDescription4.GetOutfit(OutfitCategories.Naked, 0)
                                                     .GetPartPreset(
                                                         ResourceKey.FromString(
                                                             "0x034AEECB-0x00000000-0x0603B3F0BE3C7883")) == null)
                                    ...
                                    try
                                    {
                                        ...
                                        {
                                            if ((Actor.IsMale && Actor.SimDescription.YoungAdultOrAdult) ||
                                                (GetPlayer(Actor).IsTransfem && Actor.SimDescription.YoungAdultOrAdult))
                                            {
                                                WearCondom(Actor, false);
                                            }
                                            else if ((Partner.Actor.IsMale &&
                                                      Partner.Actor.SimDescription.YoungAdultOrAdult) ||
                                                     (GetPlayer(Partner.Actor).IsTransfem &&
                                                      Partner.Actor.SimDescription.YoungAdultOrAdult))
                                            {
                                                WearCondom(Partner.Actor, false);
                                            }
                                ...
                                else if (Part.Players.Count == 3 && Part.Position.MaxSims == 3)
                                {
                                    ...
                                    try
                                    {
                                            ...
                                            simDescription4.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x0603B3F0BE3C7883")) != null)
                                        {
                                            SwitchToPeener(sim4, false);
                                        }

                                        if (Part.Position.Creator != "SM" &&
                                            simDescription5.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x0603B3F0BE3C7883")) != null)
                                        {
                                            SwitchToPeener(sim5, false);
                                        }

                                        if (sim3.IsFemale && !Part.Position.PutOnStraOn[1] &&
                                            Settings.FemaleUseStrapOn &&
                                            sim3.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        {
                                        ...
                                        if (sim4.IsFemale && !Part.Position.PutOnStraOn[2] &&
                                            Settings.FemaleUseStrapOn &&
                                            sim4.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        {
                                        ...
                                        if (sim5.IsFemale && !Part.Position.PutOnStraOn[3] &&
                                            Settings.FemaleUseStrapOn &&
                                            sim5.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        {
                                        ...
                                        if (sim3.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim3.SimDescription.IsPregnant &&
                                            sim3.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                        ...
                                        if (sim4.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim4.SimDescription.IsPregnant &&
                                            sim4.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                        ...
                                        if (sim5.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim5.SimDescription.IsPregnant &&
                                            sim5.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[3])
                                        {
                                        ...
                                        if (Part.Position.Creator == "SM")
                                        {
                                            if (sim3.IsFemale && Settings.FemaleUseStrapOn &&
                                                sim3.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                    .GetPartPreset(
                                                        ResourceKey.FromString(
                                                            "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                            ...
                                            if (sim4.IsFemale && Settings.FemaleUseStrapOn &&
                                                sim4.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                    .GetPartPreset(
                                                        ResourceKey.FromString(
                                                            "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                            ...
                                            if (sim5.IsFemale && Settings.FemaleUseStrapOn &&
                                                sim5.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                    .GetPartPreset(
                                                        ResourceKey.FromString(
                                                            "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim3.IsMale && Part.Position.Creator == "SM" &&
                                            sim3.SimDescription.YoungAdultOrAdult)
                                        {
                                            SwitchToPeener(sim3, true);
                                        }

                                        if (sim4.IsMale && Part.Position.Creator == "SM" &&
                                            sim4.SimDescription.YoungAdultOrAdult)
                                        {
                                            SwitchToPeener(sim4, true);
                                        }

                                        if (sim5.IsMale && Part.Position.Creator == "SM" &&
                                            sim5.SimDescription.YoungAdultOrAdult)
                                        {
                                        ...
                                        if (Settings.UseCondom && !Settings.CondomIsBroken)
                                        {
                                            if ((sim3.IsMale && sim3.SimDescription.YoungAdultOrAdult) ||
                                                (GetPlayer(sim3).IsTransfem && sim3.SimDescription.YoungAdultOrAdult))
                                            {
                                                WearCondom(sim3, true);
                                            }

                                            if ((sim4.IsMale && sim4.SimDescription.YoungAdultOrAdult) ||
                                                (GetPlayer(sim4).IsTransfem && sim4.SimDescription.YoungAdultOrAdult))
                                            {
                                                WearCondom(sim4, true);
                                            }

                                            if ((sim5.IsMale && sim5.SimDescription.YoungAdultOrAdult) ||
                                                (GetPlayer(sim5).IsTransfem && sim5.SimDescription.YoungAdultOrAdult))
                                            {
                                        ...
                                        {
                                            if (simDescription3.GetOutfit(OutfitCategories.Naked, 0)
                                                    .GetPartPreset(
                                                        ResourceKey.FromString(
                                                            "0x034AEECB-0x00000000-0x41FB479D5736C3F2")) != null)
                                            {
                                                WearCondom(sim3, false);
                                            }

                                            if (simDescription4.GetOutfit(OutfitCategories.Naked, 0)
                                                    .GetPartPreset(
                                                        ResourceKey.FromString(
                                                            "0x034AEECB-0x00000000-0x41FB479D5736C3F2")) != null)
                                            {
                                            ...
                                            if (simDescription5.GetOutfit(OutfitCategories.Naked, 0)
                                                    .GetPartPreset(
                                                        ResourceKey.FromString(
                                                            "0x034AEECB-0x00000000-0x41FB479D5736C3F2")) != null)
                                            {
                                ...
                                else if (Part.Players.Count == 4 && Part.Position.MaxSims == 4)
                                {
                                    ...
                                    try
                                    {
                                        if (sim6.IsFemale && !Part.Position.PutOnStraOn[1] &&
                                            Settings.FemaleUseStrapOn &&
                                            sim6.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        {
                                        ...
                                        if (sim7.IsFemale && !Part.Position.PutOnStraOn[2] &&
                                            Settings.FemaleUseStrapOn &&
                                            sim7.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        {
                                        ...
                                        if (sim8.IsFemale && !Part.Position.PutOnStraOn[3] &&
                                            Settings.FemaleUseStrapOn &&
                                            sim8.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        {
                                        ...
                                        if (sim9.IsFemale && !Part.Position.PutOnStraOn[4] &&
                                            Settings.FemaleUseStrapOn &&
                                            sim9.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        {
                                        ...
                                        if (sim6.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim6.SimDescription.IsPregnant &&
                                            sim6.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                        ...
                                        if (sim7.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim7.SimDescription.IsPregnant &&
                                            sim7.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                        ...
                                        if (sim8.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim8.SimDescription.IsPregnant &&
                                            sim8.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                        ...
                                        if (sim9.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim9.SimDescription.IsPregnant &&
                                            sim9.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[4])
                                        {
                                ...
                                else if (Part.Players.Count == 5 && Part.Position.MaxSims == 5)
                                {
                                    ...
                                    try
                                    {
                                        if (sim10.IsFemale && !Part.Position.PutOnStraOn[1] &&
                                            Settings.FemaleUseStrapOn && sim10.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim11.IsFemale && !Part.Position.PutOnStraOn[2] &&
                                            Settings.FemaleUseStrapOn && sim11.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim12.IsFemale && !Part.Position.PutOnStraOn[3] &&
                                            Settings.FemaleUseStrapOn && sim12.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim13.IsFemale && !Part.Position.PutOnStraOn[4] &&
                                            Settings.FemaleUseStrapOn && sim13.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim14.IsFemale && !Part.Position.PutOnStraOn[5] &&
                                            Settings.FemaleUseStrapOn && sim14.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim10.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim10.SimDescription.IsPregnant &&
                                            sim10.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[1])
                                        ...
                                        if (sim11.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim11.SimDescription.IsPregnant &&
                                            sim11.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[2])
                                        ...
                                        if (sim12.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim12.SimDescription.IsPregnant &&
                                            sim12.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[3])
                                        ...
                                        if (sim13.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim13.SimDescription.IsPregnant &&
                                            sim13.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[4])
                                        ...
                                        if (sim14.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim14.SimDescription.IsPregnant &&
                                            sim14.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[5])
                                        {
                                ...
                                else if (Part.Players.Count == 6 && Part.Position.MaxSims == 6)
                                {
                                    ...
                                    try
                                    {
                                        if (sim15.IsFemale && !Part.Position.PutOnStraOn[1] &&
                                            Settings.FemaleUseStrapOn && sim15.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim16.IsFemale && !Part.Position.PutOnStraOn[2] &&
                                            Settings.FemaleUseStrapOn && sim16.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim17.IsFemale && !Part.Position.PutOnStraOn[3] &&
                                            Settings.FemaleUseStrapOn && sim17.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim18.IsFemale && !Part.Position.PutOnStraOn[4] &&
                                            Settings.FemaleUseStrapOn && sim18.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim19.IsFemale && !Part.Position.PutOnStraOn[5] &&
                                            Settings.FemaleUseStrapOn && sim19.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim20.IsFemale && !Part.Position.PutOnStraOn[6] &&
                                            Settings.FemaleUseStrapOn && sim20.SimDescription
                                                .GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) != null)
                                        ...
                                        if (sim15.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim15.SimDescription.IsPregnant &&
                                            sim15.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[1])
                                        ...
                                        if (sim16.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim16.SimDescription.IsPregnant &&
                                            sim16.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[2])
                                        ...
                                        if (sim17.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim17.SimDescription.IsPregnant &&
                                            sim17.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[3])
                                        ...
                                        if (sim18.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim18.SimDescription.IsPregnant &&
                                            sim18.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[4])
                                        ...
                                        if (sim19.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim19.SimDescription.IsPregnant &&
                                            sim19.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[5])
                                        ...
                                        if (sim20.IsFemale && Settings.FemaleUseStrapOn && !IsTransfem &&
                                            !sim20.SimDescription.IsPregnant &&
                                            sim20.SimDescription.GetOutfit(OutfitCategories.Naked, 0)
                                                .GetPartPreset(
                                                    ResourceKey.FromString(
                                                        "0x034AEECB-0x00000000-0x92245A61BDDD4F2A")) == null &&
                                            Part.Position.PutOnStraOn[6])
                                        {
                ...
                try
                {
                    if (Actor.IsMale && Actor.SimDescription.GetOutfitCount(OutfitCategories.Naked) != 1)
                    {
                        SwitchToPeener(Actor, false);
                        if (previousOutfitCategory != OutfitCategories.Naked)
                        {
                            Actor.SwitchToOutfitWithoutSpin(previousOutfitCategory, previousOutfitIndex);
                             ...
                             Partner.Actor.SimDescription.GetOutfitCount(OutfitCategories.Naked) != 1)
                    {
                        SwitchToPeener(Partner.Actor, false);
                        if (previousOutfitCategory != OutfitCategories.Naked)
                        {
                ...
                try
                {
                    if (Actor.IsFemale && Actor.SimDescription.GetOutfitCount(OutfitCategories.Naked) != 1)
                    {
                        SwitchToStrapon(Actor, false);
                        if (previousOutfitCategory != OutfitCategories.Naked)
                        {
                    ...
                    if (Actor.IsFemale && GetPlayer(Actor).IsTransfem &&
                        Actor.SimDescription.GetOutfitCount(OutfitCategories.Naked) != 1)
                    {
                        WearCondom(Actor, false);
                        if (previousOutfitCategory != OutfitCategories.Naked)
                        {
            ...
            public bool WearCondom(Sim playerSim, bool condomOnDick)
            {
                ...
                try
                {
                    if (condomOnDick && !Settings.CondomIsBroken && Settings.UseCondom)
                    {
                        ...
                        if (simDescription2.GetOutfit(OutfitCategories.Naked, 0)
                                .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0x5BF7D41C6F2D94E8")) ==
                            null)
                        {
                            if (!RandomUtil.CoinFlip())
                            {
                                SimOutfit uniform =
                                    new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x28A1DEBB221B6632"));
                                SimOutfit resultOutfit;
                                if (OutfitUtils.TryApplyUniformToOutfit(
                                        simDescription2.GetOutfit(OutfitCategories.Naked, 0), uniform, simDescription2,
                                        "RedCondom", out resultOutfit))
                                {
                                    simDescription2.AddOutfit(resultOutfit, OutfitCategories.Naked, true);
                                    SwitchOutfitHelper =
                                        new Sim.SwitchOutfitHelper(playerSim, OutfitCategories.Naked, 0);
                            ...
                            {
                                SimOutfit uniform2 =
                                    new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x51E7AC8E736EDB12"));
                                SimOutfit resultOutfit2;
                                if (OutfitUtils.TryApplyUniformToOutfit(
                                        simDescription2.GetOutfit(OutfitCategories.Naked, 0), uniform2, simDescription2,
                                        "GreenCondom", out resultOutfit2))
                                {
                            ...
                            {
                                SimOutfit uniform3 =
                                    new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0xFCB5B98600AE92C8"));
                                SimOutfit resultOutfit3;
                                if (OutfitUtils.TryApplyUniformToOutfit(
                                        simDescription2.GetOutfit(OutfitCategories.Naked, 0), uniform3, simDescription2,
                                        "WhiteCondom", out resultOutfit3))
                                {
                    ...
                    else if (!condomOnDick)
                    {
                        ...
                        if ((simDescription3.GetOutfitCount(OutfitCategories.Naked) != 1 &&
                             simDescription3.GetOutfit(OutfitCategories.Naked, 0)
                                 .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0x5BF7D41C6F2D94E8")) !=
                             null && Settings.CondomIsBroken) ||
                            (simDescription3.GetOutfitCount(OutfitCategories.Naked) != 1 &&
                             simDescription3.GetOutfit(OutfitCategories.Naked, 0)
                                 .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0x5BF7D41C6F2D94E8")) !=
                             null && !Settings.UseCondom) ||
                            (simDescription3.GetOutfitCount(OutfitCategories.Naked) != 1 &&
                             simDescription3.GetOutfit(OutfitCategories.Naked, 0)
                                 .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0x5BF7D41C6F2D94E8")) !=
                             null && Settings.RemoveCondom))
                        {
                            if (simDescription3.GetOutfit(OutfitCategories.Naked, 0)
                                    .GetPartPreset(
                                        ResourceKey.FromString("0x034AEECB-0x00000000-0x0603B3F0BE3C7883")) == null)
                            {
            ...
            public bool SwitchToStrapon(Sim playerSim, bool addRemove)
            {
                ...
                try
                {
                    ...
                    if ((Settings.FemaleUseStrapOn && simDescription.GetOutfit(OutfitCategories.Naked, 0)
                                .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0xB25D1F4F442041E6")) !=
                            null) || (Settings.FemaleUseStrapOn && simDescription.GetOutfit(OutfitCategories.Naked, 0)
                                .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0x23697088F9BC3EA8")) !=
                            null) || (Settings.FemaleUseStrapOn && simDescription.GetOutfit(OutfitCategories.Naked, 0)
                            .GetPartPreset(ResourceKey.FromString("0x034AEECB-0x00000000-0x49CBFB1B775EC86E")) != null))
                    {
                    ...
                    if (addRemove)
                    {
                        ...
                        if (simDescription2.GetOutfitCount(OutfitCategories.Naked) == 1)
                        {
                            // generate new outfit
                            SimOutfit uniform =
                                new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0xCE17741BF55E817A"));
                            SimOutfit resultOutfit;
                            if (OutfitUtils.TryApplyUniformToOutfit(
                                    simDescription2.GetOutfit(OutfitCategories.Naked, 0), uniform, simDescription2,
                                    "fAccessoryStrapon", out resultOutfit))
                            {
                                simDescription2.AddOutfit(resultOutfit, OutfitCategories.Naked, true);
            ...
            public bool SwitchToPeener(Sim playerSim, bool addIt)
            {
                ...
                {
                    PassionCommon.SystemMessage(
                        "SpaceMan Peener is not installed. SM animations will use the default penis.");
                    return false;
                }
                ...
                if (World.ResourceExists(key))
                {
                    try
                    {
                        if (addIt)
                        {
                            ...
                            {
                                SimOutfit uniform =
                                    new SimOutfit(ResourceKey.FromString("0x025ED6F4-0x00000000-0x5F49653E2405BBFB"));
                                SimOutfit resultOutfit;
                                if (OutfitUtils.TryApplyUniformToOutfit(
                                        simDescription.GetOutfit(OutfitCategories.Naked, 0), uniform, simDescription,
                                        "Spaceman_ Peener", out resultOutfit))
                                {
                        ...
                        else if (!addIt)
                        {
                            ...
                            {
                                if (simDescription2.GetOutfitCount(OutfitCategories.Naked) != 1 &&
                                    simDescription2.GetOutfit(OutfitCategories.Naked, 0)
                                        .GetPartPreset(
                                            ResourceKey.FromString("0x034AEECB-0x00000000-0x5BF7D41C6F2D94E8")) == null)
                                {
                                ...
                                else if (simDescription2.GetOutfitCount(OutfitCategories.Naked) != 1 &&
                                         simDescription2.GetOutfit(OutfitCategories.Naked, 0)
                                             .GetPartPreset(
                                                 ResourceKey.FromString("0x034AEECB-0x00000000-0x5BF7D41C6F2D94E8")) !=
                                         null)
                                {
                                    simDescription2.RemoveOutfit(OutfitCategories.Naked, 0, true);
                                    try
            ...
            {
                if (!IsValid || !target.IsValid || !target.IsActive ||
                    !Actor.RouteToObjectRadialRange(target.Actor, 1.5f, 3f) || !target.IsValid || !target.IsActive)
                {
                    return;
                }
                ...
                currentInteraction.BeginCommodityUpdate(
                    new CommodityChange(CommodityKind.Fun, 100f, false, 100f, OutputUpdateType.First, false, true,
                        UpdateAboveAndBelowZeroType.Either), 1f);
                ...
                while (IsWatching && Actor.HasNoExitReason() && target.IsActive &&
                       (!currentInteraction.Autonomous || SimClock.CurrentTicks < num))
                {
                    if (SimClock.CurrentTicks > num2)
                    {
                        // if a sim is a party animal or is the RNG check passes a sim who is watching may join
                        // ...rewrite this
                        if (Settings.AutonomyChance > 0 && (Actor.HasTrait(TraitNames.PartyAnimal) ||
                                                            RandomUtil.GetInt(0, 299) < Settings.AutonomyChance))
                        {
                            if (IsAutonomous && target.HasPart && target.Part.IsAutonomous && target.Part.HasRoom &&
                                WillPassion(target.Part) && Join(target.Part))
                            {
                                currentInteraction.EndCommodityUpdates(true);
                                DirectStartLoop();
                                return;
                        ...
                        Actor.PlayReaction(PassionCommon.RandomReactionPos, target.Actor,
                            ReactionSpeed.ImmediateWithoutOverlay);
            ...
            public void Switch(Player partner)
            {
                ...
                else
                {
                    ...
                    Actor.InteractionQueue.AddNext(Interactions.SwitchRoute.Singleton.CreateInstance(partner.Actor,
                        Actor, new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
                    partner.Actor.InteractionQueue.AddNext(Interactions.SwitchRoute.Singleton.CreateInstance(Actor,
                        partner.Actor, new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
            ...
            public bool Leave()
            {
                ...
                try
                {
                    ...
                    try
                    {
                        if (!ActiveLeave && !CanSwitch && Settings.GetSoft && (!Settings.StrapOnMode || HasRealPenis))
                        {
                            GetSoft();
                        }
                    }
            ...
            public void RegisterWoohoo()
            {
                ...
                {
                    EventTracker.SendEvent(new WooHooEvent(EventTypeId.kWooHooed, Actor, Partner.Actor,
                        Part.Target.Object));
                }
                else
                {
        ...
        public class Target
        {
            ...
            [PersistableStatic] private static Dictionary<PassionType, int> _mMinSimsList;

            [PersistableStatic] private static Dictionary<PassionType, int> _mMaxSimsList;
            ...
            public int MinSims
            {
                get { return GetMinSims(ObjectType); }
            }
            ...
            public int MaxSims
            {
                get { return GetMaxSims(ObjectType); }
            }
            ...
            public bool IsValid
            {
                get { return ObjectType != null && Location != Vector3.Empty; }
            }
            ...
            public void CreateParts()
            {
                ...
                if (ObjectType.Is<BedDouble>())
                {
                    try
                    {
                        ...
                        part.Location.Set(Location.x + Forward.z * 0f - Forward.z * 0.4f, Location.y,
                            Location.z + Forward.z * 0f + Forward.x * 0.4f);
                        part3.Location.Set(Location.x + Forward.z * 0f - Forward.z * -0.4f, Location.y,
                            Location.z + Forward.z * 0f + Forward.x * -0.4f);
                        AddPart(part);
                        AddPart(part2);
                        AddPart(part3);
                ...
                if (ObjectType.Is<TableDining3x1>())
                {
                    try
                    {
                        ...
                        part4.Location.Set(Location.x + Forward.z * 0f - Forward.z * 0.5f, Location.y,
                            Location.z + Forward.z * 0f + Forward.x * 0.5f);
                        part5.Location.Set(Location.x + Forward.z * 0f - Forward.z * -0.5f, Location.y,
                            Location.z + Forward.z * 0f + Forward.x * -0.5f);
                        AddPart(part4);
                        AddPart(part5);
                        return;
                ...
                if (ObjectType.Is<Sofa>())
                {
                    try
                    {
                        ...
                        part6.Location.Set(Location.x + Forward.z * 0f - Forward.z * 0.5f, Location.y,
                            Location.z + Forward.z * 0f + Forward.x * 0.5f);
                        AddPart(part6);
                        return;
                    }
                ...
                if (ObjectType.Is<MassageTable>())
                {
                    try
                    {
                        ...
                        part7.Location.Set(Location.x + Forward.z * 0f - Forward.z * 0f, Location.y,
                            Location.z + Forward.z * 0f + Forward.x * 0f);
                        AddPart(part7);
                        return;
                    }
                    catch
                ...
                if (ObjectType.Is<CornerBathtub>(false))
                {
                    try
                    {
                        ...
                        part13.Location.Set(Location.x + Forward.z * 0f - Forward.z * 0.5f, Location.y,
                            Location.z + Forward.z * 0f + Forward.x * 0.5f);
                        AddPart(part13);
                        return;
                    }
                ...
                if (ObjectType.Is<CounterIsland>(false))
                {
                    try
                    {
                        Part part14 = CreatePart(PartArea.Middle,
                            new Vector3(Location.x - Forward.x * 0.25f, Location.y, Location.z), -Forward);
                        AddPart(part14);
                        return;
                    }
                    catch
                ...
                if (ObjectType.Is<Sink>(false))
                {
                    try
                    {
                        Part part16 = CreatePart(PartArea.Middle,
                            new Vector3(Location.x + Forward.z * 0f - Forward.x * 0.25f, Location.y, Location.z),
                            Forward);
                        AddPart(part16);
                        return;
                    }
                ...
                if (ObjectType.Is<CarExpensive1>(false))
                {
                    try
                    {
                        Part part17 = CreatePart(PartArea.Middle,
                            new Vector3(Location.x + Forward.z * 0f + Forward.x * 0.25f, Location.y, Location.z),
                            Forward);
                        AddPart(part17);
                        return;
                ...
                if (ObjectType.Is<BoatSpeedBoat>() || ObjectType.Is<BoatSpeedFishingBoat>())
                {
                    try
                    {
                        ...
                        if ((num3 > 1f && num4 > 1f && num3 > num4 && Forward.x > Forward.z) ||
                            (num3 < 1f && num4 < 1f && num3 < num4 && 0f - Forward.x > 0f - Forward.z))
                        {
                        ...
                        else if ((num3 > 1f && num4 < 1f && num3 > num4 && Forward.x < 0f - Forward.z) ||
                                 (num3 < 1f && num4 > 1f && num3 < num4 && 0f - Forward.x < Forward.z))
                        {
                        ...
                        else if ((num3 > 1f && num4 > 1f && num3 < num4 && Forward.x < Forward.z) ||
                                 (num3 <= 1f && num4 < 1f && num3 > num4 && 0f - Forward.x < 0f - Forward.z))
                        {
                            num5 = Location.x - (Forward.x * 0f - Forward.z * -8.5E-08f) - Forward.x +
                                   Forward.z / 1.05f;
                ...
                if (ObjectType.Is<BoatWaterScooter>())
                {
                    try
                    {
                        ...
                        if ((num16 > 1f && num17 > 1f && num16 > num17 && Forward.x > Forward.z) ||
                            (num16 < 1f && num17 < 1f && num16 < num17 && 0f - Forward.x > 0f - Forward.z))
                        {
                            if (num16 > 1f && num17 > 1f && num16 > num17 && Forward.x > Forward.z)
                            {
                        ...
                        else if ((num16 > 1f && num17 < 1f && num16 > num17 && Forward.x < 0f - Forward.z) ||
                                 (num16 < 1f && num17 > 1f && num16 < num17 && 0f - Forward.x < Forward.z))
                        {
                        ...
                        else if ((num16 > 1f && num17 > 1f && num16 < num17 && Forward.x < Forward.z) ||
                                 (num16 <= 1f && num17 < 1f && num16 > num17 && 0f - Forward.x < 0f - Forward.z))
                        {
                            if (num16 > 1f && num17 > 1f && num16 < num17 && Forward.x < Forward.z)
                            {
                ...
                if (ObjectType.Is<FixerCar>(false))
                {
                    try
                    {
                        Part part20 = CreatePart(PartArea.Middle,
                            new Vector3(Location.x + Forward.z * 0f - Forward.x * 0.55f, Location.y,
                                Location.z + Forward.z * 0f + Forward.x * 0.3f), Forward);
                        AddPart(part20);
                        return;
                    }
                    catch
                ...
                if (ObjectType.Is<FixerCar.FixerCarFixed>(false))
                {
                    try
                    {
                        Part part21 = CreatePart(PartArea.Middle,
                            new Vector3(Location.x + Forward.z * 0f - Forward.x * 0.55f, Location.y,
                                Location.z + Forward.z * 0f + Forward.x * 0.3f), Forward);
                        AddPart(part21);
                        return;
            ...
            public void DisablePassthrough(Player player)
            {
                try
                {
                    if (player != null && player.IsValid && HasObject &&
                        (Object is IHasPortalComponent || Object is IPortalConnectionObject))
                    {
                        PortalComponent portalComponent = Object.PortalComponent;
                        if (portalComponent != null)
                        {
                            bool preferredLaneSelected = false;
                            portalComponent.LockRoutingLane(player.Actor, Object.Position, false,
                                Route.RouteOption.None, out preferredLaneSelected);
            ...
            public static PartArea ChooseSectionDialog(PassionType pt)
            {
                ...
                if (pt != null && pt.IsValid)
                {
                    if (pt.Is<BedDouble>())
                    {
                        switch (ThreeButtonDialog.Show(PassionCommon.Localize("S3_Passion.Terms.WhatPartOfBed"),
                                    PassionCommon.Localize("S3_Passion.Terms.LeftSide"),
                                    PassionCommon.Localize("S3_Passion.Terms.Center"),
                                    PassionCommon.Localize("S3_Passion.Terms.RightSide")))
                        {
                    ...
                    {
                        switch (ThreeButtonDialog.Show(PassionCommon.Localize("S3_Passion.Terms.WhatPartOfHotTub"),
                                    PassionCommon.Localize("S3_Passion.Terms.LeftSide"),
                                    PassionCommon.Localize("S3_Passion.Terms.Center"),
                                    PassionCommon.Localize("S3_Passion.Terms.RightSide")))
                        {
                    ...
                    {
                        result = ((!TwoButtonDialog.Show(PassionCommon.Localize("S3_Passion.Terms.WhatPartOfHotTub"),
                            PassionCommon.Localize("S3_Passion.Terms.Top"),
                            PassionCommon.Localize("S3_Passion.Terms.Bottom")))
                            ? PartArea.Bottom
                            : PartArea.Top);
                    }
                    else if (pt.Is<TableDining3x1>())
                    {
                        result = ((!TwoButtonDialog.Show(PassionCommon.Localize("S3_Passion.Terms.WhatPartOfTable"),
                            PassionCommon.Localize("S3_Passion.Terms.LeftSide"),
                            PassionCommon.Localize("S3_Passion.Terms.RightSide")))
                            ? PartArea.Right
                            : PartArea.Left);
        ...
        public class Part
        {
            ...
            {
                get { return GetPosition(CurrentPositionKey); }
            }

            public PassionType Type
            {
                get { return (Target != null) ? Target.ObjectType : null; }
            }
            ...
            public bool PositionChanged
            {
                ...
                set { MPositionChanged = value; }
            }

            public bool HasRoom
            {
                get { return Players.Count < MaxSims; }
            }
            ...
            {
                get { return CurrentSequence != null; }
            }

            public bool HasInitiator
            {
                get { return Initiator != null; }
            }
            ...
            public int Count
            {
                get
                {
                    ...
                    {
                        if (value != null &&
                            (value.State == PassionState.Ready || value.State == PassionState.Animating))
                        {
                            num++;
                        }
                    }
            ...
            public int Remaining
            {
                get
                {
                    ...
                    foreach (Player value in Players.Values)
                    {
                        if (value != null && value.State != PassionState.Stopping &&
                            value.State != PassionState.Leaving)
                        {
                            num++;
                        }
                    }
                ...
                get
                {
                    ...
                    if (HasTarget && Target.IsValid && Target.HasObject)
                    {
                        if (Type.NeedsParts)
                        {
                            ...
                            if ((part != null || part2 != null) && ((part != null && part.ContainedSim != null) ||
                                                                    (part2 != null && part2.ContainedSim != null)))
                            {
                                return true;
                            }
                        }
                ...
                if (HasTarget && Target.IsValid && Target.HasObject)
                {
                    if (Type.NeedsParts)
                    {
                        ...
                        if ((part != null || part2 != null) &&
                            ((part != null && part.ContainedSim != null && part.ContainedSim != excluded) ||
                             (part2 != null && part2.ContainedSim != null && part2.ContainedSim != excluded)))
                        {
                            return true;
                        }
                    }
            ...
            public static void GetPartsForTarget(GameObject target, PartArea targetPart, out PartData part1,
                out PartData part2)
            {
                part1 = null;
                part2 = null;
            ...
            public bool RefreshInitiator()
            {
                ...
                foreach (Player value in Players.Values)
                {
                    if (value != null && (value.State == PassionState.Ready || value.State == PassionState.Animating ||
                                          (value.State == PassionState.Routing &&
                                           value.GetDistanceTo(Target as IGameObject) < 5f)))
                    {
                        Initiator = value;
                    }
                }
                ...
                if (!HasInitiator)
                {
                    ...
                    {
                        if (value2 != null && value2.State != PassionState.Stopping &&
                            value2.State != PassionState.Leaving && value2.State != PassionState.Deny)
                        {
                            Initiator = value2;
                        }
                    }
            ...
            public void GetRandomValidPosition()
            {
                ...
                IPositionChoice randomValidPosition =
                    Position.GetRandomValidPosition(Type, Count, penises, vaginas, flag ? num2 : num);
                            ...
                            foreach (Player item in values)
                            {
                                ...
                                if (slot != null && slot.NeedsPenis)
                                {
                                    if (item.HasVisiblePenis)
                                    {
                                        ...
                                        if (player == null || !player.HasVisiblePenis)
                                        {
                                            player = item;
                                        }
                                    }
                                    else if (player == null || (item.PositionIndex == i && !player.HasVisiblePenis))
                                    {
                                        player = item;
                                    }
                                }
            ...
            public bool CanAnimate(out List<Player> ready)
            {
                ...
                foreach (Player value in Players.Values)
                {
                    ...
                    else if (value.State == PassionState.Animating ||
                             (value.State == PassionState.Routing && value.GetDistanceTo(Location) < 5f))
                    {
                        flag = false;
                    }
                }
            ...
            public void StartVisualEffects()
            {
                ...
                try
                {
                    if (Target.ObjectType.Is<Shower>() || Target.ObjectType.Is<ShowerOutdoor>() ||
                        Target.ObjectType.Is<ShowerPublic_Dance>())
                    {
                    ...
                    else if (Target.ObjectType.Is<Altar>() && Target.Object.GetResourceKey().ToString() ==
                             "319e4f1d:28000000:000000000098a21e")
                    {
            ...
            public void StartSoundEffects()
            {
                ...
                try
                {
                    if (Target.ObjectType.Type == typeof(Shower) || Target.ObjectType.Type == typeof(ShowerTub) ||
                        Target.ObjectType.Type == typeof(ShowerPublic_Dance))
                    {
            ...
            public bool BrokenCondom()
            {
                try
                {
                    ...
                    if (Settings.UseCondom && Settings.CondomBrakeChance > 0 && HasPosition &&
                        World.ResourceExists(key) && World.ResourceExists(key2))
                    {
                        foreach (Player value in Players.Values)
                        {
                            ...
                            if (value.HasRealPenis && !value.Actor.Inventory.ContainsType(typeof(CondomPack), 1) &&
                                !value.Actor.Inventory.ContainsType(typeof(SingleCondom), 1) &&
                                !Settings.PassionFuckSession)
                            {
                                Settings.PassionFuckSession = true;
                                try
                                {
                                    PassionCommon.SimMessage(
                                        PassionCommon.Localize("Fuck! I don't have any condoms!").ToString(),
                                        value.Actor);
                                    PassionCommon.Wait();
                                }
                                catch
                            ...
                            if (value.HasRealPenis && value.Actor.Inventory.ContainsType(typeof(SingleCondom), 1) &&
                                !Settings.PassionFuckSession)
                            {
                                Settings.PassionFuckSession = true;
                            ...
                            else if (value.HasRealPenis && value.Actor.Inventory.ContainsType(typeof(CondomPack), 1) &&
                                     !value.Actor.Inventory.ContainsType(typeof(SingleCondom), 1) &&
                                     !Settings.PassionFuckSession)
                            {
                                Settings.PassionFuckSession = true;
                            ...
                            foreach (Player value2 in Players.Values)
                            {
                                ...
                                if (value2.HasRealPenis &&
                                    !value2.Actor.Inventory.ContainsType(typeof(CondomPack), 1) &&
                                    !value2.Actor.Inventory.ContainsType(typeof(SingleCondom), 1) &&
                                    !Settings.PassionFuckSession)
                                {
                                    Settings.PassionFuckSession = true;
                                    try
                                ...
                                try
                                {
                                    if (((value2.HasRealPenis && PassionCommon.Match((uint)Position.Categories, 4)) ||
                                         (value2.HasRealPenis && PassionCommon.Match((uint)Position.Categories, 8)) ||
                                         (value2.HasRealPenis && PassionCommon.Match((uint)Position.Categories, 12))) &&
                                        RandomUtil.RandomChance(Settings.CondomBrakeChance))
                                    {
                                        try
                                        {
                                            PassionCommon.SimMessage(
                                                PassionCommon.Localize("Shit! The condom broke!").ToString(),
                                                value2.Actor);
                                            PassionCommon.Wait();
                                        }
                                        catch
                                ...
                                try
                                {
                                    if (((!value.HasRealPenis || !PassionCommon.Match((uint)Position.Categories, 4)) &&
                                         (!value.HasRealPenis || !PassionCommon.Match((uint)Position.Categories, 8)) &&
                                         (!value.HasRealPenis ||
                                          !PassionCommon.Match((uint)Position.Categories, 12))) ||
                                        !RandomUtil.RandomChance(Settings.CondomBrakeChance)) continue;
                                    try
                                    {
                                        PassionCommon.SimMessage(
                                            PassionCommon.Localize("Shit! The condom broke!").ToString(),
            ...
            public void CheckPregnancy()
            {
                try
                {
                    if (Settings.PregnancyMethod == PregnancyMethod.Disabled || Settings.PregnancyRisk <= 0 ||
                        !HasPosition)
                    {
                        return;
                    }
                    ...
                    foreach (Player value in Players.Values)
                    {
                        if (!value.IsValid || !value.IsActive || value.IsStopping ||
                            value.Actor.SimDescription.IsPregnant || (!value.Actor.IsFemale && !Settings.PregnancyMale))
                        {
                            continue;
                        }
                        ...
                        foreach (Player value2 in Players.Values)
                        {
                            if (!value2.IsActive || value2.Actor == value.Actor ||
                                (!value2.HasRealPenis &&
                                 (Settings.PregnancyMethod != PregnancyMethod.ByPosition ||
                                  !Position.PossibleSameSexPregnancy) &&
                                 Settings.PregnancyMethod != PregnancyMethod.KwSystem) ||
                                ((Settings.PregnancyMethod != PregnancyMethod.ByCategory ||
                                  !PassionCommon.Match((uint)Position.Categories, 12)) &&
                                 (Settings.PregnancyMethod != PregnancyMethod.ByPosition ||
                                  !Position.PossiblePregnancy) &&
                                 (Settings.PregnancyMethod != PregnancyMethod.KwSystem || !value.Actor.IsFemale ||
                                  !PassionCommon.Match((uint)Position.Categories, 4)) &&
                                 (Settings.PregnancyMethod != PregnancyMethod.KwSystem || !value.Actor.IsMale ||
                                  !PassionCommon.Match((uint)Position.Categories, 8)) &&
                                 (Settings.PregnancyMethod != PregnancyMethod.KwSystem ||
                                  !PassionCommon.Match((uint)Position.Categories, 12))))
                            {
                                continue;
                            ...
                            if (RandomUtil.RandomChance(Settings.PregnancyRisk) &&
                                !value.Actor.SimDescription.IsPregnant && !value2.Actor.SimDescription.IsPregnant &&
                                value.Actor.SimDescription.IsFemale && value2.Actor.SimDescription.IsMale)
                            {
                            ...
                            if (RandomUtil.RandomChance(Settings.PregnancyRisk) &&
                                !value2.Actor.SimDescription.IsPregnant && value.Actor.SimDescription.IsMale &&
                                value2.Actor.SimDescription.IsFemale)
                            {
                            ...
                            if ((RandomUtil.RandomChance(Settings.PregnancyRisk) &&
                                 !value.Actor.SimDescription.IsPregnant && !value2.Actor.SimDescription.IsPregnant &&
                                 value.Actor.SimDescription.IsFemale && !value.HasRealPenis &&
                                 value2.Actor.SimDescription.IsFemale && !value2.HasRealPenis) ||
                                (RandomUtil.RandomChance(Settings.PregnancyRisk) &&
                                 !value.Actor.SimDescription.IsPregnant && !value2.Actor.SimDescription.IsPregnant &&
                                 value.Actor.SimDescription.IsFemale && !value.HasRealPenis &&
                                 value2.Actor.SimDescription.IsFemale && value2.HasRealPenis))
                            {
                            ...
                            else if (((RandomUtil.RandomChance(Settings.PregnancyRisk) &&
                                       value.Actor.SimDescription.IsMale && value2.Actor.SimDescription.IsFemale &&
                                       value2.HasRealPenis) ||
                                      (RandomUtil.RandomChance(Settings.PregnancyRisk) && Settings.PregnancyMale &&
                                       value.Actor.SimDescription.IsMale && value2.Actor.SimDescription.IsMale)) &&
        ...
        public class Position : IPositionChoice
        {
            public class Category
            {
                ...
                {
                    if (PassionCommon.Match((uint)i, 1))
                    {
                        return PassionCommon.Localize("S3_Passion.Terms.All");
                    }

                    string text = string.Empty;
                    if (PassionCommon.Match((uint)i, 12))
                    {
                        text += PassionCommon.Localize("S3_Passion.Terms.Fuck");
                    }

                    if (PassionCommon.Match((uint)i, 2))
                    {
                        text = text + ((text.Length > 0) ? ", " : "") + PassionCommon.Localize("S3_Passion.Terms.Oral");
                    }

                    if (PassionCommon.Match((uint)i, 48))
                    {
                        text = text + ((text.Length > 0) ? ", " : "") +
                               PassionCommon.Localize("S3_Passion.Terms.Manual");
                    }
            ...
            public class Animation
            {
                ...
                public class Set
                {
                    ...
                    public ClipData GetClip(Player player)
                    {
                        try
                        {
                            if (player != null && player.IsValid && Slots != null &&
                                Slots.ContainsKey(player.PositionIndex) && Slots[player.PositionIndex] != null)
                            {
                            ...
                            if (PassionCommon.Testing)
                            {
                                ...
                                {
                                    PassionCommon.BufferLine("  Slots does not contain player.PositionIndex (" +
                                                             player.PositionIndex + ")");
                                    PassionCommon.BufferLine("  Slots.Count == " + Slots.Count);
                                    foreach (KeyValuePair<int, Slot> slot in Slots)
                                    {
                                        PassionCommon.BufferLine("    Slot " + slot.Key + ": " +
                                                                 ((slot.Value != null) ? "!null" : "null"));
                                    }
                                }
                    ...
                    public void GiveHeldItem(Player player)
                    {
                        ...
                        if (slot != null && slot.HasHeldItem)
                        {
                            try
                            {
                                if (player.HeldItem == null || !player.HeldItem.IsValid ||
                                    player.HeldItem.Key != slot.HeldItem.Key)
                                {
                                    HeldItem.Create(player, slot.HeldItem.Key, slot.HeldItem.Location,
                                        slot.HeldItem.Facing, slot.HeldItem.Angle, slot.HeldItem.Slot);
                                }
                            }
                            catch
                            {
                        ...
                        try
                        {
                            if (player != null && player.IsValid)
                            {
                                foreach (ClipData clip in Clips)
                                {
                                    ...
                                    {
                                        if (((player.HasVisiblePenis && clip.NeedsPenis) ||
                                             (player.HasVagina && clip.NeedsVagina)) && clip.CompareFlags(player.Flags))
                                        {
                                            return clip;
                                        }
                            ...
                            {
                                PassionCommon.SystemMessage("Error: " +
                                                            PassionCommon.Localize("Logic break in Position Clip"));
                            }
                        }
                        catch
                        {
                ...
                public class ClipData
                {
                    ...
                    public bool IsValid
                    {
                        get { return Exists(Clip); }
                    }

                    public static ClipData CreateFromAnimatedWoohoo(string clip1, string clip2, int position,
                        int participants)
                    {
                        ...
                        return new ClipData(
                            clip1 + AwPosition[position] + clip2 + ((participants == 3) ? "o" : string.Empty),
                            position == 1, false);
                    }

                    public static bool Exists(string clip)
                    {
                        return !string.IsNullOrEmpty(clip) &&
                               global::Sims3.SimIFace.Animation.ClipExists(clip, ProductVersion.BaseGame);
                    }
                ...
                public class Prefix
                {
                    ...
                    public static string Gender(Sim sim, bool checkPenis)
                    {
                        ...
                        {
                            return (!checkPenis)
                                ? Get((int)sim.SimDescription.Gender)
                                : ((!PassionCommon.HasPart(sim, SimPart.Penis)) ? Get(8192) : Get(4096));
                        }
                    ...
                    if (file.IsValid)
                    {
                                    ...
                                    foreach (Xml.Node matchingNode8 in matchingNode.GetMatchingNodes("Set"))
                                    {
                                        ...
                                        foreach (Xml.Node matchingNode9 in matchingNode8.GetMatchingNodes("Player"))
                                        {
                                            ...
                                            if (matchingNode2 != null)
                                            {
                                                ...
                                                Vector3 location = ((matchingNode3 != null)
                                                    ? new Vector3(PassionCommon.Float(matchingNode3.GetAttribute("X")),
                                                        PassionCommon.Float(matchingNode3.GetAttribute("Y")),
                                                        PassionCommon.Float(matchingNode3.GetAttribute("Z")))
                                                    : Vector3.Empty);
                                                Xml.Node matchingNode4 = matchingNode2.GetMatchingNode("Facing");
                                                Vector3 facing = ((matchingNode4 != null)
                                                    ? new Vector3(PassionCommon.Float(matchingNode4.GetAttribute("X")),
                                                        PassionCommon.Float(matchingNode4.GetAttribute("Y")),
                                                        PassionCommon.Float(matchingNode4.GetAttribute("Z")))
                                                    : Vector3.Empty);
                                                float angle = PassionCommon.Float(matchingNode2["Angle"]);
                                                uint slot2 = 3703456078u;
                                                try
                                                {
                                                    slot2 = (string.IsNullOrEmpty(matchingNode2["Slot"])
                                                        ? 3703456078u
                                                        : ((uint)Enum.Parse(typeof(HeldItem.ItemSlots),
                                                            matchingNode2["Slot"], true)));
                                                }
                                                catch
                                                {
                                                    if (PassionCommon.Testing)
                                                    {
                                                        PassionCommon.BufferMessage(
                                                            "Error parsing Held Item slot for " + position.Name +
                                                            "(Set:" + num2 + ",Slot:" + num3 + ")");
                                                    }
                                                }

                                                slot.HeldItem = HeldItem.Create(matchingNode2["ObjectKey"], location,
                                                    facing, angle, slot2);
                                                ...
                                                if (!string.IsNullOrEmpty(attribute))
                                                {
                                                    ...
                                                    foreach (string text4 in array4)
                                                    {
                                                        switch (text4.ToLower())
                                                        {
                                                            ...
                                                            default:
                                                                cAsAgeGenderFlags =
                                                                    (CASAgeGenderFlags)((uint)cAsAgeGenderFlags |
                                                                        (uint)PassionCommon.Int(text4));
                                                                break;
                                                        }
                                                    }
                                                }
                        ...
                        if (node2 != null)
                        {
                            foreach (Xml.Node matchingNode11 in node2.GetMatchingNodes("WooHooStage"))
                            {
                                ...
                                foreach (Xml.Node item in matchingNodes)
                                {
                                    ...
                                    bool flag = text5.Contains("male") && (!text5.Contains("female") ||
                                                                           PassionCommon.Bool(item["UseStrapon"]));
                                    ...
                                    for (int k = position2.MinSims; k <= position2.MaxSims; k++)
                                    {
                                        ...
                                        if (matchingNode5 != null)
                                        {
                                            ...
                                            float angle2 = PassionCommon.Float(matchingNode5["Angle"]) *
                                                (float)Math.PI / 180f;
                                            if (matchingNode5.GetAttribute("Key") != "WoodenSpoon")
                                            {
                                                try
                                                {
                                                    slot4 = (uint)Enum.Parse(typeof(HeldItem.ItemSlots),
                                                        matchingNode5["Slot"], true);
                                                }
                                                catch
                                                {
                                                }
                                            ...
                                            else if (matchingNode5.GetAttribute("Key") == "WoodenSpoon")
                                            {
                                                ...
                                                try
                                                {
                                                    slot4 = (uint)Enum.Parse(typeof(HeldItem.ItemSlots), "LeftHand",
                                                        true);
                                                }
                                                catch
                                                {
                                        ...
                                        if (position2.UseTheWhip)
                                        {
                                            ...
                                            slot3.HeldItem = HeldItem.Create("0x02DC343F-0x00000000-0x0000000000DF58B3",
                                                vector2, zero, angle3, slot5);
                                ...
                                foreach (string text6 in array5)
                                {
                                    switch (text6)
                                    {
                                        ...
                                        case "Scarecrow":
                                            position2
                                                .AddSupportedType<
                                                    global::Sims3.Gameplay.Objects.Environment.Scarecrow>();
                                            break;
                                        case "HauntedHouse":
                        ...
                        if (node3 != null)
                        {
                            foreach (Xml.Node matchingNode12 in node3.GetMatchingNodes("Position"))
                            {
                                ...
                                {
                                    position3.TeenHeightAdjustment =
                                        PassionCommon.Float(matchingNode12["teenFixHeight"]);
                                }

                                if (!string.IsNullOrEmpty(matchingNode12["possiblePregnancy"]))
                                {
                                    position3.PossiblePregnancy =
                                        PassionCommon.Bool(matchingNode12["possiblePregnancy"]);
                                }

                                if (!string.IsNullOrEmpty(matchingNode12["possibleSameSexPregnancy"]))
                                {
                                    position3.PossibleSameSexPregnancy =
                                        PassionCommon.Bool(matchingNode12["PossibleSameSexPregnancy"]);
                                }
            ...
            public static IPositionChoice GetRandomValidPosition(PassionType type, int participants, int penises,
                int vaginas)
            {
            ...
            public static List<IPositionChoice> GetValidSequences(PassionType type, int participants, int categories)
            {
                ...
                if (type != null && participants > 0)
                {
                    foreach (Sequence sequence in Sequences)
                    {
                        if (sequence.CanUseWith(participants) && sequence.CanUseWith(type) &&
                            sequence.IsCategory(categories))
                        {
                            list.Add(sequence);
                        }
                    }
            ...
            public static List<IPositionChoice> GetValidPositions(PassionType type, int participants, int penises,
                int vaginas, int categories)
            {
                List<IPositionChoice> list = new List<IPositionChoice>();
                if (type != null && participants > 0)
                {
                    ...
                    {
                        if (value.CanUseWith(participants) && value.CanUseWith(type) && value.IsCategory(categories) &&
                            (!Settings.ExcludeInvalidPositions ||
                             ((value.Sets.ContainsKey(participants) || value.Sets[participants] != null) &&
                              penises >= value.Sets[participants].PenisesNeeded &&
                              vaginas >= value.Sets[participants].VaginasNeeded)))
                        {
                            list.Add(value);
                        }
                    }
            ...
            public void GiveHeldItems(List<Player> players)
            {
                ...
                foreach (Player player in players)
                {
                    ...
                    if (slot.HasHeldItem)
                    {
                        if (World.ResourceExists(ResourceKey.FromString("0x02DC343F-0x00000000-0x00000000590CD0E0")) &&
                            World.ResourceExists(ResourceKey.FromString("0x02DC343F-0x00000000-0x0000000059C1465B")) &&
                            World.ResourceExists(ResourceKey.FromString("0x02DC343F-0x00000000-0x00000000042C4C21")) &&
                            World.ResourceExists(ResourceKey.FromString("0x02DC343F-0x00000000-0x000000000D4B42F6")) &&
                            World.ResourceExists(ResourceKey.FromString("0x02DC343F-0x00000000-0x000000002734DB7A")) &&
                            World.ResourceExists(ResourceKey.FromString("0x02DC343F-0x00000000-0x000000004E6DFBC4")) &&
                            World.ResourceExists(ResourceKey.FromString("0x02DC343F-0x00000000-0x0000000038B3F337")) &&
                            World.ResourceExists(ResourceKey.FromString("0x02DC343F-0x00000000-0x000000004964A3B5")) &&
                            (slot.HeldItem.Key == ResourceKey.FromString("0x02DC343F-0x00000000-0x780597AC522896FB") ||
                             slot.HeldItem.Key == ResourceKey.FromString("0x02DC343F-0x00000000-0x00000000590CD0E0") ||
                             ...
                             slot.HeldItem.Key == ResourceKey.FromString("0x02DC343F-0x00000000-0x000000004964A3B5")))
                        {
                            if (RandomUtil.CoinFlip())
                            {
                                if (RandomUtil.CoinFlip())
                                {
                                    ...
                                    {
                                        slot.HeldItem.Key =
                                            ResourceKey.FromString("0x02DC343F-0x00000000-0x780597AC522896FB");
                                    }
                                    else
                                    {
                                        slot.HeldItem.Key =
                                            ResourceKey.FromString("0x02DC343F-0x00000000-0x0000000059C1465B");
                                    }
                                }
                                else if (RandomUtil.CoinFlip())
                                {
                                    slot.HeldItem.Key =
                                        ResourceKey.FromString("0x02DC343F-0x00000000-0x00000000042C4C21");
                                }
                                else
                                {
                                    slot.HeldItem.Key =
                                        ResourceKey.FromString("0x02DC343F-0x00000000-0x000000000D4B42F6");
                                }
                            }
                            else if (RandomUtil.CoinFlip())
                            {
                                ...
                                {
                                    slot.HeldItem.Key =
                                        ResourceKey.FromString("0x02DC343F-0x00000000-0x000000002734DB7A");
                                }
                                else
                                {
                                    slot.HeldItem.Key =
                                        ResourceKey.FromString("0x02DC343F-0x00000000-0x000000004E6DFBC4");
                                }
                            }
                            else if (RandomUtil.CoinFlip())
                            {
            ...
            public static IPositionChoice ChoosePositionDialog(PassionType type, int participants, int penises,
                int vaginas)
            {
                ...
                list.Add(new ObjectPicker.HeaderInfo(PassionCommon.Localize("S3_Passion.Terms.Participants"), null,
                    50));
                List<ObjectPicker.TabInfo> list2 = new List<ObjectPicker.TabInfo>();
                list2.Add(new ObjectPicker.TabInfo("shop_all_r2", PassionCommon.Localize("S3_Passion.Terms.All"),
                    PositionListForDialog(type, participants, penises, vaginas)));
                ObjectPicker.TabInfo tabInfo = new ObjectPicker.TabInfo("shop_skill_r2",
                    PassionCommon.Localize("S3_Passion.Terms.Masturbate"),
                    PositionListForDialog(type, participants, penises, vaginas, 16));
                if (tabInfo.RowInfo.Count >= 0)
                {
                    list2.Add(tabInfo);
                }

                ObjectPicker.TabInfo tabInfo2 = new ObjectPicker.TabInfo("shop_skill_r2",
                    PassionCommon.Localize("S3_Passion.Terms.Oral"),
                    PositionListForDialog(type, participants, penises, vaginas, 2));
                if (tabInfo2.RowInfo.Count >= 0)
                {
                    list2.Add(tabInfo2);
                }

                ObjectPicker.TabInfo tabInfo3 = new ObjectPicker.TabInfo("shop_skill_r2",
                    PassionCommon.Localize("S3_Passion.Terms.Vaginal"),
                    PositionListForDialog(type, participants, penises, vaginas, 4));
                if (tabInfo3.RowInfo.Count >= 0)
                {
                    list2.Add(tabInfo3);
                }

                ObjectPicker.TabInfo tabInfo4 = new ObjectPicker.TabInfo("shop_skill_r2",
                    PassionCommon.Localize("S3_Passion.Terms.Anal"),
                    PositionListForDialog(type, participants, penises, vaginas, 8));
                if (tabInfo4.RowInfo.Count >= 0)
                {
                    list2.Add(tabInfo4);
                }

                List<ObjectPicker.RowInfo> list3 =
                    MenuList.Show(PassionCommon.Localize("S3_Passion.Terms.ChangePosition"),
                        PassionCommon.Localize("S3_Passion.Terms.Ok"),
                        PassionCommon.Localize("S3_Passion.Terms.Cancel"), list2, list);
            ...
            public static List<ObjectPicker.RowInfo> PositionListForDialog(PassionType type, int participants,
                int penises, int vaginas)
            {
                return PositionListForDialog(type, participants, penises, vaginas, 1);
            }

            public static List<ObjectPicker.RowInfo> PositionListForDialog(PassionType type, int participants,
                int penises, int vaginas, int category)
            {
                ...
                foreach (Sequence sequence in Sequences)
                {
                    ...
                    {
                        ObjectPicker.RowInfo rowInfo =
                            new ObjectPicker.RowInfo(sequence, new List<ObjectPicker.ColumnInfo>());
                        rowInfo.ColumnInfo.Add(new ObjectPicker.TextColumn("\"" + sequence.Name + "\""));
                        rowInfo.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(" -" + PassionCommon.Localize("S3_Passion.Terms.Sequence") +
                                                        "- "));
                        ...
                        {
                            rowInfo.ColumnInfo.Add(
                                new ObjectPicker.TextColumn(sequence.MinSims + "-" + sequence.MaxSims));
                        }
                ...
                foreach (Position value in Positions.Values)
                {
                    ...
                    {
                        ObjectPicker.RowInfo rowInfo2 =
                            new ObjectPicker.RowInfo(value, new List<ObjectPicker.ColumnInfo>());
                        rowInfo2.ColumnInfo.Add(
                            new ObjectPicker.TextColumn(value.NamePrefix + PassionCommon.Localize(value.Name)));
            ...
            public static Position ChooseSequencePositionDialog(Dictionary<string, PassionType> types, int minsims,
                int maxsims)
            {
                ...
                List<ObjectPicker.TabInfo> list2 = new List<ObjectPicker.TabInfo>();
                list2.Add(new ObjectPicker.TabInfo("shop_all_r2", PassionCommon.Localize("S3_Passion.Terms.All"),
                    PositionListForSequenceDialog(types, minsims, maxsims)));
                ObjectPicker.TabInfo tabInfo = new ObjectPicker.TabInfo("shop_skill_r2",
                    PassionCommon.Localize("S3_Passion.Terms.Masturbate"),
                    PositionListForSequenceDialog(types, minsims, maxsims, 16));
                if (tabInfo.RowInfo.Count >= 0)
                {
                    list2.Add(tabInfo);
                }
                ...
                ObjectPicker.TabInfo tabInfo2 = new ObjectPicker.TabInfo("shop_skill_r2",
                    PassionCommon.Localize("S3_Passion.Terms.Oral"),
                    PositionListForSequenceDialog(types, minsims, maxsims, 2));
                if (tabInfo2.RowInfo.Count >= 0)
                {
                    list2.Add(tabInfo2);
                }
                ...
                ObjectPicker.TabInfo tabInfo3 = new ObjectPicker.TabInfo("shop_skill_r2",
                    PassionCommon.Localize("S3_Passion.Terms.Vaginal"),
                    PositionListForSequenceDialog(types, minsims, maxsims, 4));
                if (tabInfo3.RowInfo.Count >= 0)
                {
                    list2.Add(tabInfo3);
                }
                ...
                ObjectPicker.TabInfo tabInfo4 = new ObjectPicker.TabInfo("shop_skill_r2",
                    PassionCommon.Localize("S3_Passion.Terms.Anal"),
                    PositionListForSequenceDialog(types, minsims, maxsims, 8));
                if (tabInfo4.RowInfo.Count >= 0)
                {
                    list2.Add(tabInfo4);
                }
                ...
                List<ObjectPicker.RowInfo> list3 =
                    MenuList.Show(PassionCommon.Localize("S3_Passion.Terms.SelectPosition"),
                        PassionCommon.Localize("S3_Passion.Terms.Ok"),
                        PassionCommon.Localize("S3_Passion.Terms.Cancel"), list2, list);
                if (list3 != null && list3.Count > 0)
                {
            ...
            public static List<ObjectPicker.RowInfo> PositionListForSequenceDialog(
                Dictionary<string, PassionType> types, int minsims, int maxsims)
            {
                return PositionListForSequenceDialog(types, minsims, maxsims, 1);
            }

            public static List<ObjectPicker.RowInfo> PositionListForSequenceDialog(
                Dictionary<string, PassionType> types, int minsims, int maxsims, int categories)
            {
                List<ObjectPicker.RowInfo> list = new List<ObjectPicker.RowInfo>();
                foreach (Position value in Positions.Values)
                {
        ...
        public class Sequence : IPositionChoice
        {
            ...
            public bool IsCategory(int category)
            {
                return category == 1 || Categories == 1 || PassionCommon.Match((uint)category, (uint)Categories);
            }
        ...
        public class HeldItem
        {
            ...
            public GameObject Object
            {
                get
                {
                    if (MObject == null && Key != ResourceKey.kInvalidResourceKey && HoldingPlayer != null &&
                        HoldingPlayer.IsValid)
                    {
                        GenerateObject();
                    }
            ...
            {
                get { return MHoldingPlayer; }
                set
                {
                    MHoldingPlayer = value;
                    if (MObject != null)
                    {
                        Slots.AttachToSlot(MId, HoldingPlayer.Actor.ObjectId, Slot, false, ref Location, ref Facing,
                            Angle);
                    }
                    else
                    {
            ...
            public bool IsValid
            {
                get { return Key != ResourceKey.kInvalidResourceKey && Object != null && !Object.HasBeenDestroyed; }
            }
            ...
            public static HeldItem Create(Player player, ResourceKey key, Vector3 location, Vector3 facing, float angle,
                uint slot)
            {
                if (player != null)
                {
            ...
            protected void GenerateObject()
            {
                try
                {
                    Simulator.ObjectInitParameters initData =
                        new Simulator.ObjectInitParameters(0uL, Location, 0, Facing, HiddenFlags.Nothing);
        ...
        public class Interactions
        {
            ...
            {
                [DoesntRequireTuning]
                private sealed class Definition : InteractionDefinition<Sim, Sim, UseSimForPassion>, IHasTraitIcon,
                    IHasMenuPathIcon
                {
                        ...
                        ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                    {
                        if (!isAutonomous && IsValid(actor) && target != null)
                        {
                            ...
                            if (player.IsActive || player.IsInPool || player.IsWatching || player2.IsActive ||
                                player2.IsInPool || !IsValid(player2.Actor) || (player.Actor != player2.Actor &&
                                    !Settings.ActiveAlwaysAccepts && !player.WillPassion(player2)))
                            {
                                return false;
                            }
                ...
                public override bool Run()
                {
                    ...
                    if (player.IsValid)
                    {
                        if (player2 != null && player2.IsValid)
                        {
                            ...
                            {
                                GameObject[] objects =
                                    global::Sims3.Gameplay.Queries.GetObjects<GameObject>(player2.Location, 3f);
                                if (objects != null && objects.Length != 0)
                                {
                                    ...
                                    foreach (GameObject gameObject in array)
                                    {
                                        ...
                                        PartData partData = ((gameObject.PartComponent != null)
                                            ? gameObject.PartComponent.GetPartSimIsIn(player2.Actor)
                                            : null);
                                        if (partData != null || gameObject.IsActorUsingMe(player2.Actor))
                                        {
                                            location = player.Location;
                                            forward = player.Forward;
                                            if (gameObject is Bed || gameObject is Couch || gameObject is ChairLiving ||
                                                gameObject is ChairLounge || gameObject is ChairSectional)
                                            {
                                                Target target = GetTarget(gameObject);
                                                if (target != null && target.HasObject &&
                                                    !target.IsOccupiedByOtherSims(player2.Actor))
                                                {
                        ...
                        if (player.Join(GetTarget(location, forward)))
                        {
                            ...
                            if (player.PartnersToCheckCount > 0)
                            {
                                foreach (Player item in player.PartnersToCheck)
                                {
                                    ...
                                    {
                                        player.Actor.InteractionQueue.AddNext(
                                            AskToPassion.Singleton.CreateInstance(item.Actor, player.Actor,
                                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false,
                                                true));
                                    }
                                }
            ...
            {
                [DoesntRequireTuning]
                private sealed class Definition : InteractionDefinition<Sim, IGameObject, UseObjectForPassion>,
                    IHasTraitIcon, IHasMenuPathIcon
                {
                    public ResourceKey GetTraitIcon(Sim actor, GameObject target)
                    {
                        return Interactions.GetTraitIcon(actor, target);
                    ...
                    public override string GetInteractionName(Sim actor, IGameObject target,
                        InteractionObjectPair interaction)
                    {
                        return Settings.SoloLabel;
                    }

                    public override bool Test(Sim actor, IGameObject target, bool isAutonomous,
                        ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                    {
                ...
                public override bool Run()
                {
                    ...
                    {
                        GameObject[] objects =
                            global::Sims3.Gameplay.Queries.GetObjects<GameObject>(target.Location, 1f);
                        if (objects != null && objects.Length != 0)
                        {
                            GameObject[] array = objects;
                            foreach (GameObject gameObject in array)
                            {
                                ...
                                try
                                {
                                    if (target2.ObjectType.Name.ToString() == "Couch" ||
                                        target2.ObjectType.Name.ToString() == "Sofa" ||
                                        target2.ObjectType.Name.ToString() == "Loveseat" ||
                                        target2.ObjectType.Name.ToString().Contains("Chair") ||
                                        target2.ObjectType.Name.ToString().Contains("Table") ||
                                        target2.ObjectType.Name.ToString().Contains("Bed") ||
                                        target2.ObjectType.Name.ToString() == "Altar")
                                    {
                    ...
                    if (player.Join(target))
                    {
                        ...
                        {
                            player.Actor.InteractionQueue.PushAsContinuation(
                                RouteToPassion.Singleton.CreateInstance(Actor, Actor,
                                    new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), true);
                        }
            ...
            {
                [DoesntRequireTuning]
                private sealed class Definition : InteractionDefinition<Sim, IGameObject, UseObjectForPassionWithSim>,
                    IHasTraitIcon, IHasMenuPathIcon
                {
                    public ResourceKey GetTraitIcon(Sim actor, GameObject target)
                    {
                    ...
                    if (target.ObjectType.Name.ToString() == "Rug")
                    {
                        ...
                        if (objects != null && objects.Length != 0)
                        {
                            ...
                            foreach (GameObject gameObject in array)
                            {
                                ...
                                try
                                {
                                    if (target2.ObjectType.Name.ToString().Contains("Table") ||
                                        target2.ObjectType.Name.ToString() == "Couch" ||
                                        target2.ObjectType.Name.ToString() == "Sofa" ||
                                        target2.ObjectType.Name.ToString() == "Loveseat" ||
                                        target2.ObjectType.Name.ToString().Contains("Chair") ||
                                        target2.ObjectType.Name.ToString() == "Fridge" ||
                                        target2.ObjectType.Name.ToString().Contains("Bed") ||
                                        target2.ObjectType.Name.ToString() == "Stove" ||
                                        target2.ObjectType.Name.ToString() == "Counter" ||
                                        target2.ObjectType.Name.ToString() == "Toilet" ||
                                        target2.ObjectType.Name.ToString().Contains("Shower") ||
                                        target2.ObjectType.Name.ToString() == "Altar" ||
                                        target2.ObjectType.Name.ToString() == "DoorSingle")
                                    {
                                        target = GetTarget(gameObject);
                                        break;
                                    }
            ...
            internal sealed class BeginPassion : Interaction<Sim, Sim>
            {
                ...
                private sealed class Definition : InteractionDefinition<Sim, Sim, BeginPassion>
                {
                    public override string GetInteractionName(Sim actor, Sim target, InteractionObjectPair interaction)
                    {
                        return PassionCommon.Localize(PassionCommon.Localize("S3_Passion.Terms.Beginning") + " " +
                                                      Settings.Label);
                    }
                ...
                private sealed class Definition : InteractionDefinition<Sim, Sim, PassionLoop>
                {
                    public override string GetInteractionName(Sim actor, Sim target, InteractionObjectPair interaction)
                    {
                        if (actor != null)
                        {
                            ...
                            {
                                return Settings.ActiveLabel + PassionCommon.NewLine +
                                       PassionCommon.Localize(player.Part.Position.Name);
                            }
                        }
            ...
            internal sealed class SwitchRoute : Interaction<Sim, Sim>
            {
                ...
                private sealed class Definition : InteractionDefinition<Sim, Sim, SwitchRoute>
                {
                    public override string GetInteractionName(Sim actor, Sim target, InteractionObjectPair interaction)
                    {
                        return PassionCommon.Localize("S3_Passion.Terms.SwitchingWith") + " " +
            ...
            internal sealed class MoveTo : ImmediateInteraction<Sim, IGameObject>
            {
                ...
                public override bool Run()
                {
                    ...
                    {
                        player.Actor.InteractionQueue.AddNext(MoveRoute.Singleton.CreateInstance(target.Object, Actor,
                            new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
                        player.ActiveLeaveJoin = true;
                        player.Stop();
                        return true;
                    ...
                    if (target != null && target.IsValid && target.HasObject && player.IsValid && player.HasPart)
                    {
                        ...
                        foreach (Player value in player.Part.Players.Values)
                        {
                            if (value != player)
                            {
                                ...
                                value.Actor.InteractionQueue.AddNext(MoveGroupRoute.Singleton.CreateInstance(
                                    target.Object, value.Actor,
                                    new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
                        ...
                        player.Actor.InteractionQueue.AddNext(MoveGroupRoute.Singleton.CreateInstance(target.Object,
                            player.Actor, new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
                        player.ActiveLeaveJoin = true;
                        player.Stop();
                        return true;
                    }
            ...
            internal sealed class MoveGroupRoute : Interaction<Sim, IGameObject>
            {
                ...
                public override bool Run()
                {
                    if (Actor != null && Target != null)
                    {
                        Player player = GetPlayer(Actor);
                        Target target = GetTarget(Target);
                        if (player.IsValid && target.HasObject && player.HasSwitchPart &&
                            player.Join(player.SwitchPart))
                        {
                            player.Route();
                        }
            ...
            internal sealed class JoinPassion : ImmediateInteraction<Sim, Sim>
            {
                        ...
                        ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                    {
                        if (!isAutonomous && IsValid(actor))
                        {
                            try
                            {
                                Player player = GetPlayer(actor);
                                Player player2 = GetPlayer(target);
                                if (!player.IsActive && player2.IsActive && player2.HasPart && player2.Part.HasRoom &&
                                    player.WillPassion(player2.Part))
                                {
                                    return true;
                                }
                            }
                ...
                public override bool Run()
                {
                    Player player = GetPlayer(Actor);
                    Player player2 = GetPlayer(Target);
                    if (player.IsValid && player2.IsValid && player2.HasPart && player2.Part.HasTarget &&
                        player2.Part.HasRoom)
                    {
                        player.Join(player2.Part);
                        Actor.InteractionQueue.AddNext(RouteToPassion.Singleton.CreateInstance(player.Actor,
                            player.Actor, new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
                    }
            ...
            internal sealed class ActiveJoinPassion : ImmediateInteraction<Sim, Sim>
            {
                        ...
                        ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                    {
                        if (!isAutonomous && IsValid(actor))
                        {
                            try
                            {
                                Player player = GetPlayer(actor);
                                Player player2 = GetPlayer(target);
                                if (player.IsSolo && player2.IsActive && player.Actor != player2.Actor &&
                                    player2.HasPart && player2.Part.HasRoom && player.WillPassion(player2.Part))
                                {
                                    return true;
                                }
                            }
                ...
                public override bool Run()
                {
                    Player player = GetPlayer(Actor);
                    Player player2 = GetPlayer(Target);
                    if (player.IsSolo && player2.IsValid && player2.HasPart && player2.Part.HasTarget &&
                        player2.Part.HasRoom)
                    {
                        player.ActiveLeave = true;
                        player.Stop();
                        player.Actor.InteractionQueue.AddNext(DelayedJoinPassion.Singleton.CreateInstance(player2.Actor,
                            player.Actor, new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
                    }
            ...
            internal sealed class DelayedJoinPassion : Interaction<Sim, Sim>
            {
                ...
                public override bool Run()
                {
                    if (Actor != null && Target != null)
                    {
                        Player player = GetPlayer(Actor);
                        Player player2 = GetPlayer(Target);
                        if (player.IsValid && player2.HasPart && player2.Part.HasRoom &&
                            player.WillPassion(player2.Part))
                        {
            ...
            internal sealed class AskToJoinPassion : ImmediateInteraction<Sim, Sim>
            {
                        ...
                        ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                    {
                        if (!isAutonomous && IsValid(target))
                        {
                            try
                            {
                                Player player = GetPlayer(actor);
                                Player player2 = GetPlayer(target);
                                if (player.IsActive && !player2.IsActive && player.HasPart && player.Part.HasRoom &&
                                    player2.WillPassion(player.Part))
                                {
                                    return true;
                                }
                            }
                ...
                public override bool Run()
                {
                    ...
                    Target.InteractionQueue.AddNext(JoinPassion.Singleton.CreateInstance(Actor, Target,
                        new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
                    return true;
                }
            }
            ...
            internal sealed class AskToPassionOther : ImmediateInteraction<Sim, Sim>
            {
                            ...
                            try
                            {
                                if (actor != null && target != null && actor != target && !GetPlayer(target).IsActive)
                                {
                                    ...
                                    Relationship relationship =
                                        actor.SimDescription.GetRelationship(target.SimDescription, false);
                ...
                public override bool Run()
                {
                    ...
                    if (player.Join(target))
                    {
                        ...
                        {
                            Target.InteractionQueue.CancelAllInteractions();
                            Target.InteractionQueue.AddNext(RouteToPassion.Singleton.CreateInstance(Actor, Target,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
                        }
            ...
            internal sealed class AskToSoloPassion : ImmediateInteraction<Sim, Sim>
            {
                ...
                public override bool Run()
                {
                    ...
                    if (player.Join(target))
                    {
                        ...
                        {
                            player.Actor.InteractionQueue.AddNext(RouteToPassion.Singleton.CreateInstance(player.Actor,
                                player.Actor, new InteractionPriority(InteractionPriorityLevel.UserDirected), false,
                                true));
                        }
            ...
            internal sealed class AutoSoloPassion : ImmediateInteraction<Sim, Sim>
            {
                ...
                private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, AutoSoloPassion>
                {
                        ...
                        ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                    {
                        try
                        {
                            if (IsValid(target) && actor != null && target != null && actor != target &&
                                !GetPlayer(target).IsActive)
                            {
                                Relationship relationship =
                                    actor.SimDescription.GetRelationship(target.SimDescription, false);
                            }
            ...
            internal sealed class AskToWatchPassion : ImmediateInteraction<Sim, Sim>
            {
                        ...
                        ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                    {
                        if (!isAutonomous && IsValid(target))
                        {
                            try
                            {
                                Player player = GetPlayer(actor);
                                Player player2 = GetPlayer(target);
                                if (player.IsActive && !player2.IsActive && !player2.IsWatching &&
                                    !player.Actor.SimDescription.ChildOrBelow && player.Actor.SimDescription.IsHuman)
                                {
                                    return true;
                                }
                ...
                public override bool Run()
                {
                    Target.InteractionQueue.AddNext(WatchPassion.Singleton.CreateInstance(Actor, Target,
                        new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
                    return true;
                }
            }
            ...
            internal sealed class WatchPassion : ImmediateInteraction<Sim, Sim>
            {
                ...
                private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, WatchPassion>
                {
                        ...
                        ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                    {
                        ...
                        Player player2 = GetPlayer(target);
                        if (player.IsValid && !player.IsActive && player2.IsValid && player2.IsActive &&
                            !player.Actor.SimDescription.ChildOrBelow && player.Actor.SimDescription.IsHuman)
                        {
                            return true;
                        }
                ...
                public override bool Run()
                {
                    Actor.InteractionQueue.AddNext(WatchLoop.Singleton.CreateInstance(Target, Actor,
                        new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
                    return true;
                }
            }
            ...
            internal sealed class WatchMasturbate : ImmediateInteraction<Sim, Sim>
            {
                ...
                private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, WatchMasturbate>
                {
                    ...
                    {
                        Player player = GetPlayer(a);
                        if (player.IsWatching && IsValid(a) && a == target &&
                            !player.Actor.SimDescription.ChildOrBelow && player.Actor.SimDescription.IsHuman)
                        {
                            return true;
                        }
                ...
                public override bool Run()
                {
                    ...
                    if (player.Join(target))
                    {
                        ...
                        player.Actor.InteractionQueue.AddNext(BeginPassion.Singleton.CreateInstance(Actor, Actor,
                            new InteractionPriority(InteractionPriorityLevel.High), false, true));
            ...
            internal sealed class SetTransfemOn : ImmediateInteraction<Sim, Sim>
            {
                ...
                private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, SetTransfemOn>
                {
                    ...
                    public override bool Test(Sim actor, Sim target, bool isAutonomous,
                        ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                    {
                        if (!target.SimDescription.IsEP11Bot && !target.SimDescription.IsTimeTraveler &&
                            target.SimDescription.IsHuman && target.SimDescription.TeenOrAbove &&
                            !target.HasBeenDestroyed && !target.SimDescription.IsZombie &&
                            !target.SimDescription.Household.IsTravelHousehold &&
                            !target.SimDescription.Household.IsServiceNpcHousehold &&
                            !target.SimDescription.Household.IsServobotHousehold &&
                            !target.SimDescription.Household.IsTouristHousehold &&
                            !target.SimDescription.Household.IsAlienHousehold &&
                            !target.SimDescription.Household.IsFutureDescendantHousehold &&
                            !target.SimDescription.Household.IsMermaidHousehold &&
                            !target.SimDescription.Household.IsPetHousehold &&
                            !target.SimDescription.Household.IsPreviousTravelerHousehold &&
                            !target.SimDescription.Household.IsSpecialHousehold)
                        {
                            Player player = GetPlayer(target);
                            if (!player.IsActive && !player.IsTransfem)
                            {
                                // if the sim has a dick on their nude outfit
                                if ((!isAutonomous && IsValid(target) && target.SimDescription
                                            .GetOutfit(OutfitCategories.Naked, 0)
                                            .GetPartPreset(
                                                ResourceKey.FromString("0x034AEECB-0x00000000-0xB25D1F4F442041E6")) !=
                                        null) || (!isAutonomous && IsValid(target) && target.SimDescription
                                            .GetOutfit(OutfitCategories.Naked, 0)
                                            .GetPartPreset(
                                                ResourceKey.FromString("0x034AEECB-0x00000000-0x23697088F9BC3EA8")) !=
                                        null) || (!isAutonomous && IsValid(target) && target.SimDescription
                                            .GetOutfit(OutfitCategories.Naked, 0)
                                            .GetPartPreset(
                                                ResourceKey.FromString("0x034AEECB-0x00000000-0x49CBFB1B775EC86E")) !=
                                        null))
                                {
                                    return false;
                                }
            ...
            internal sealed class PassionSettingsMenu : ImmediateInteraction<Sim, Sim>
            {
                ...
                public override bool Run()
                {
                    PersistableSettings.Show(null, false, null, null, 0);
                    return true;
                }
            }
            ...
            internal sealed class GetHard : ImmediateInteraction<Sim, Sim>
            {
                [DoesntRequireTuning]
                private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, GetHard>
                {
                    public override string[] GetPath(bool bPath)
                    {
                        return NoPath;
                ...
                public override bool Run()
                {
                    Actor.InteractionQueue.AddNext(PassionLoop.Singleton.CreateInstance(Actor, Actor,
                        new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
            ...
            internal sealed class GetSoft : ImmediateInteraction<Sim, Sim>
            {
                [DoesntRequireTuning]
                private sealed class Definition : ImmediateInteractionDefinition<Sim, Sim, GetSoft>
                {
                    public override string[] GetPath(bool bPath)
                    {
                        return NoPath;
                ...
                private sealed class Definition : ImmediateInteractionDefinition<Sim, IGameObject, ResetMe>
                {
                        ...
                        ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                    {
                        if (!isAutonomous)
                        {
                            ...
                            {
                                if (AllPlayers.ContainsKey(value) && AllPlayers[value] != null &&
                                    !AllPlayers[value].IsActive)
                                {
                                    return true;
                                }
            ...
            {
                [DoesntRequireTuning]
                private sealed class Definition : ImmediateInteractionDefinition<Sim, IGameObject, Report>,
                    IImmediateInteractionDefinition
                {
                    public override string[] GetPath(bool bPath)
                    {
                        return PassionPath;
                ...
                public override bool Run()
                {
                    ...
                    foreach (Player value2 in AllPlayers.Values)
                    {
                        if (value2.IsValid)
                        {
                            ...
                            if (value2.HasPart)
                            {
                                PassionCommon.BufferLine("   Part.Initiator: " +
                                                         (value2.Part.HasInitiator ? value2.Part.Initiator.Name : ""));
                                ...
                                if (allTarget.Value.HasObject)
                                {
                                    ...
                                    foreach (Part value3 in value.Parts.Values)
                                    {
                                        ...
                                        foreach (Player value4 in value3.Players.Values)
                                        {
                                            if (value4.IsValid)
                                            {
                                                PassionCommon.BufferLine("    " + value4.Actor.Name +
                                                                         (value4.IsInitiator ? " (I)" : ""));
                                            }
                                        }
                                    }
            ...
            {
                [DoesntRequireTuning]
                private sealed class Definition : ImmediateInteractionDefinition<Sim, IGameObject, Test>,
                    IImmediateInteractionDefinition
                {
                    public override string[] GetPath(bool bPath)
                    {
                    ...
                    if (Test2.Exporting && Test2.Root != null && sim != null)
                    {
                        ...
                        if (player.IsValid && player.HasPart && player.Part.HasPosition)
                        {
                            try
                            {
                                ...
                                int count = player.Part.Count;
                                element.AddComment("Localized Name:  \"" +
                                                   PickString.Show(PassionCommon.Localize("New Localized Name"), "",
                                                       "") + "\"");
                                ...
                                element.AddChild("Tones",
                                    PickString.Show(PassionCommon.Localize("Tones"),
                                        PassionCommon.Localize("Currently-valid Tones are:") +
                                        "Romantic, Intense, Rough, Disinterested, Dominating, Toy", "Any"));
                                element.AddChild("Categories",
                                    PickString.Show(PassionCommon.Localize("Categories"),
                                        PassionCommon.Localize("Currently-valid Categories are:") +
                                        " None, Any, Foreplay, Oral, Anal, Vaginal, Hands, Feet, Breasts, Masturbate (Hands/Feet), Fuck (Vaginal/Anal)",
                                        "Any"));
                                ...
                                foreach (Player value3 in player.Part.Players.Values)
                                {
                                    ...
                                    if (value3.HeldItem != null)
                                    {
                                        ...
                                        Xml.Element element6 = element5.AddChild("ObjectKey",
                                            string.Format("{0:x8}-{1:x8}-{2:x16}", value3.HeldItem.Key.TypeId,
                                                value3.HeldItem.Key.GroupId, value3.HeldItem.Key.InstanceId));
                                    ...
                                    string value = PickString.Show(PassionCommon.Localize("Requirement"),
                                        PassionCommon.Localize("What clip requirements are there for ") + value3.Name +
                                        "?", "");
                                    if (!string.IsNullOrEmpty(value))
                                    {
            ...
            {
                [DoesntRequireTuning]
                private sealed class Definition : ImmediateInteractionDefinition<Sim, IGameObject, Test2>,
                    IImmediateInteractionDefinition
                {
                    public override string[] GetPath(bool bPath)
                    {
            ...
            internal sealed class Reassure : Interaction<Sim, Sim>
            {
                ...
                public override bool Run()
                {
                    ...
                    Actor.SynchronizationRole = Sim.SyncRole.Initiator;
                    Actor.SynchronizationLevel = Sim.SyncLevel.Started;
                    InteractionInstance entry = (LinkedInteractionInstance = BeReassured.Singleton.CreateInstance(Actor,
                        Target, new InteractionPriority(InteractionPriorityLevel.High), false, true));
            ...
            public sealed class UsePoolLadderForPassionWithSim : Interaction<Sim, PoolLadder>
            {
                private sealed class Definition :
                    InteractionDefinition<Sim, PoolLadder, UsePoolLadderForPassionWithSim>, IHasTraitIcon,
                    IHasMenuPathIcon
                {
                    public ResourceKey GetTraitIcon(Sim actor, GameObject target)
                    {
                    ...
                    public override string GetInteractionName(Sim actor, PoolLadder target,
                        InteractionObjectPair interaction)
                    {
                        return Settings.Label;
                    }

                    public override bool Test(Sim actor, PoolLadder target, bool isAutonomous,
                        ref GreyedOutTooltipCallback greyedOutTooltipCallback)
                    {
                        if (!isAutonomous && IsValid(actor))
                        {
                            Player player = GetPlayer(actor);
                            Target target2 = GetTarget(target);
                            if (!player.IsValid || player.IsActive || player.IsWatching || target2.MaxSims < 2 ||
                                !player.IsInPool || player.Actor.Posture.Container !=
                                Pool.GetPoolNearestPoint(target.Position))
                            {
                                return false;
                            }
                ...
                public override bool Run()
                {
                    ...
                    if (player.Join(target))
                    {
                        foreach (Sim selectedObjectsAsSim in GetSelectedObjectsAsSims())
                        {
                            ...
                            if (player2.IsValid && player2.WillPassion(player) &&
                                (Settings.ActiveAlwaysAccepts || player.WillPassion(player2)) && player2.Join(target))
                            {
                                if (player2.IsInPool &&
                                    player2.Actor.Posture.Container == Pool.GetPoolNearestPoint(Target.Position) &&
                                    player2.Join(target))
                                {
                                    player2.Actor.InteractionQueue.AddNext(
                                        RouteToPoolLadderPassion.Singleton.CreateInstance(player2.Actor, player2.Actor,
                                            new InteractionPriority(InteractionPriorityLevel.UserDirected), false,
                                            true));
                                }
                                else
                        ...
                        if (Target.PoolPortalComponent.RouteToSlotGroup(player.Actor,
                                PoolPortalComponent.RoutingSlotGroup.Inside))
                        {
            ...
            internal sealed class RouteToPoolLadderPassion : Interaction<Sim, Sim>
            {
                ...
                public override bool Run()
                {
                    ...
                    {
                        if (player.IsInPool && player.Actor.Posture is SwimmingInPool && player.Part.HasTarget &&
                            player.Part.Target.HasObject && player.Actor.Posture.Container == player.Part.Target.Object)
                        {
                            PoolLadder poolLadder = player.Part.Target.Object as PoolLadder;
                            if (poolLadder != null && poolLadder.PoolPortalComponent.RouteToSlotGroup(player.Actor,
                                    PoolPortalComponent.RoutingSlotGroup.Inside))
                            {
                                player.DirectStartLoop();
                            }
            ...
            public static readonly ResourceKey MasterOfSeduction =
                ResourceKey.CreatePNGKey("trait_masterofseduction_s", 0u);
            ...
            public static readonly string[] PassionPath = new string[1]
                { PassionCommon.Localize("S3_Passion.PassionPath") };

            public static readonly string[] RomancePath = new string[1]
                { PassionCommon.Localize("S3_Passion.RootName") };
        ...
        [PersistableStatic] protected static PersistableSettings MSettings;

        public static PersistableSettings SettingsBackup = null;

        [PersistableStatic] protected static Dictionary<ulong, Player> MAllPlayers;

        public static Dictionary<ulong, Player> AllPlayersBackup = null;

        [PersistableStatic] protected static Dictionary<ulong, Target> MAllTargets;

        [PersistableStatic] protected static List<string> MXmlFiles;

        public static List<string> XmlFilesBackup = null;

        [PersistableStatic] protected static Dictionary<string, PassionType> MLoadedTypes;

        public static Dictionary<string, PassionType> LoadedTypesBackup = null;

        [PersistableStatic] protected static Dictionary<string, Position> MPositions;

        public static Dictionary<string, Position> PositionsBackup = null;

        [PersistableStatic] protected static List<Sequence> MSequences;
        ...
        public static void Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    danceFloor.AddInteraction(CustomDance.NightFever.Singleton, true);
                ...
                foreach (Sim actor in LotManager.Actors)
                {
                    ...
                    {
                        actor.InteractionQueue.Add(Interactions.StopAllPassion.Singleton.CreateInstance(actor, actor,
                            new InteractionPriority(InteractionPriorityLevel.RequiredNPCBehavior), false, true));
                    }

                    if (actor.SimDescription.IsVampire && actor != Sim.ActiveActor && Settings.VampireInteractions &&
                        Settings.RemoveVisualOverride)
                    {
                        actor.InteractionQueue.Add(RemoveVisualOverrideOnStart.Singleton.CreateInstance(actor, actor,
                            new InteractionPriority(InteractionPriorityLevel.RequiredNPCBehavior), false, true));
                    }
                }

                if (Sim.ActiveActor.SimDescription.IsVampire && Settings.VampireInteractions &&
                    Settings.RemoveVisualOverride)
                {
                    Sim.ActiveActor.InteractionQueue.Add(RemoveVisualOverrideOnStart.Singleton.CreateInstance(
        ...
        public static ListenerAction Load(Event e)
        {
            try
            {
                ...
                {
                    gameObject.AddInteraction(CustomDance.NightFever.Singleton, true);
        ...
        private static void Load(GameObject obj)
        {
            if (obj is Sim)
            {
                ...
                if (IsValid(sim, true))
                {
                    ...
                    sim.AddInteraction(VampireMakePeeThemselves.Singleton, true);
            ...
            else if (obj != null)
            {
                ...
                if (obj is Car || obj is FixerCar || obj is FixerCar.FixerCarFixed || obj is Boat ||
                    obj is BoatWaterScooter || obj is BoatSpeedBoat || obj is BoatSpeedFishingBoat || obj is Rug ||
                    obj is Desk || obj is TableEnd || obj is TableDining1x1 || obj is TableDining2x1 ||
                    obj is TableDining3x1 || obj is TableCoffee || obj is TableBar || obj is SaunaClassic ||
                    obj is CounterIsland || obj is Counter || obj is Fridge || obj is Loveseat || obj is Sofa ||
                    obj is Shower || obj is ShowerOutdoor || obj is ToiletStall || obj is ShowerPublic_Dance ||
                    obj is ShowerTub || obj is CornerBathtub || obj is Bathtub || obj is BedSingle ||
                    obj is BedDouble || obj is Altar || obj is ChairLiving || obj is ChairDining ||
                    obj is ChairLounge || obj is ChairSectional || obj is RockingChair || obj is Urinal ||
                    obj is Toilet || obj is BrainEnhancingMachine || obj is HotTub4Seated || obj is HotTubGrotto ||
                    obj is MassageTable || obj is Windows || obj is Bicycle || obj is DoorSingle || obj is CarSports ||
                    obj is CarExpensive1 || obj is CarExpensive2 || obj is CarHatchback || obj is CarUsed1 ||
                    obj is CarUsed2 || obj is CarNormal1 || obj is CarVan4door || obj is CarPickup2door ||
                    obj is CarSedan || obj is CarHighSocietyOpen || obj is CarHighSocietyVintage ||
                    obj is CarLuxuryExotic || obj is CarLuxurySport || obj is MotorcycleRacing ||
                    obj is MotorcycleChopper || obj is BoatRowBoat || obj is AdultMagicBroom ||
                    obj is ModerateAdultBroom || obj is ExpensiveAdultBroom || obj is SculptureFloorGunShow ||
                    obj is WashingMachine || obj is Dryer || obj is PoolTable || obj is PoolLadder ||
                    obj is WorkoutBench || obj is Stove || obj is Sybian || obj is FenceRedwood_Gate ||
                    obj is SinkCounter || obj is Sink || obj is Pot || obj is PicnicTable || obj is Urnstone ||
                    obj is KissingBooth || obj is Telescope ||
                    obj is global::Sims3.Gameplay.Objects.Environment.Scarecrow || obj is HauntedHouse ||
                    obj is ScienceResearchStation || obj is HotTubBase || obj is Podium || obj is MechanicalBull)
                {
                    try
                    {
        ...
        public static void StartListening()
        {
            ...
            OnHighlyVisibleVirtuousRomance =
                EventTracker.AddListener(EventTypeId.kHighlyVisibleVirtuousRomance, Autonomy.PassionCheck);
            OnMultipleVisibleRomances =
                EventTracker.AddListener(EventTypeId.kMultipleVisibleRomances, Autonomy.PassionCheck);
            OnPerformedRomanticSingagram =
                EventTracker.AddListener(EventTypeId.kPerformedRomanticSingagram, Autonomy.PassionCheck);
        ...
        public static void CheckForVamires()
        {
            ...
            try
            {
                if ((SimClock.Hours24 == 12 || SimClock.Hours24 == 15 || SimClock.Hours24 == 19) &&
                    GuestVampiresInLot != 0 && Settings.VampiresVisitAtNight && Settings.AutonomyChance > 0 &&
                    RandomUtil.GetInt(0, 99) < Settings.AutonomyChance)
                {
                ...
                foreach (Sim actor in LotManager.Actors)
                {
                    ...
                    Relationship relationship =
                        Sim.ActiveActor.SimDescription.GetRelationship(actor.SimDescription, false);
                    if (actor.SimDescription.IsVampire && Settings.VampiresVisitAtNight &&
                        (SimClock.Hours24 >= 21 || SimClock.Hours24 <= 6) && actor != Sim.ActiveActor &&
                        !Sim.ActiveActor.Posture.Satisfies(CommodityKind.SwimmingInPool, null) &&
                        !Sim.ActiveActor.LotCurrent.IsWorldLot && actor.LotHome != Sim.ActiveActor.LotHome &&
                        relationship != null && relationship.LTR.Liking >= 90f && actor.SimDescription.TeenOrAbove &&
                        GuestVampiresInLot == 0 && GuestVampireName != actor.SimDescription.FullName.ToString())
                    {
                    ...
                    if (Settings.AutonomyChance <= 0 || RandomUtil.GetInt(0, 99) >= Settings.AutonomyChance ||
                        Sim.ActiveActor.Posture.Satisfies(CommodityKind.SwimmingInPool, null) ||
                        Sim.ActiveActor.LotCurrent.IsWorldLot || !actor.SimDescription.IsVampire ||
                        !Settings.VampiresVisitAtNight || (SimClock.Hours24 < 21 && SimClock.Hours24 > 6) ||
                        actor == Sim.ActiveActor || actor.LotHome == Sim.ActiveActor.LotHome || relationship == null ||
                        !(relationship.LTR.Liking >= 90f) || !actor.SimDescription.TeenOrAbove ||
                        actor.InteractionQueue.IsRunning(
                            Interactions.UseObjectForPassion.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), false) ||
                        actor.InteractionQueue.IsRunning(
                            Interactions.UseObjectForPassionWithSim.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), false) ||
                        actor.InteractionQueue.IsRunning(
                            Interactions.UseSimForPassion.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), false) ||
                        actor.InteractionQueue.IsRunning(
                            Interactions.ActiveJoinPassion.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), false) ||
                        actor.InteractionQueue.IsRunning(
                            Interactions.JoinPassion.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), false) ||
                        actor.InteractionQueue.IsRunning(
                            Interactions.AskToJoinPassion.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), false) ||
                        actor.InteractionQueue.IsRunning(
                            Interactions.AskToSoloPassion.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), false) ||
                        actor.InteractionQueue.IsRunning(
                            Interactions.AskToPassionOther.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), false) ||
                        actor.InteractionQueue.IsRunning(
                            Interactions.AskToWatchPassion.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), false) ||
                        actor.InteractionQueue.IsRunning(
                            Interactions.WatchPassion.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), false) ||
                        actor.InteractionQueue.IsRunning(
                            Interactions.WatchMasturbate.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true), false) ||
                        GuestVampiresInLot != 1) continue;
                    ...
                    actor.InteractionQueue.Add(GoToLot.Singleton.CreateInstance(Sim.ActiveActor.LotCurrent, actor,
                        new InteractionPriority(InteractionPriorityLevel.UserDirected), false, true));
                    EventTracker.SendEvent(EventTypeId.kInvitedSimOver, Sim.ActiveActor, actor);
                    if ((actor.SimDescription.GenderPreferenceIsFemale() &&
                         Sim.ActiveActor.SimDescription.IsFemale &&
                         Sim.ActiveActor.SimDescription.GenderPreferenceIsFemale()) ||
                        (!actor.SimDescription.GenderPreferenceIsFemale() &&
                         Sim.ActiveActor.SimDescription.IsMale &&
                         Sim.ActiveActor.SimDescription.GenderPreferenceIsFemale()) ||
                        (!actor.SimDescription.GenderPreferenceIsFemale() &&
                         Sim.ActiveActor.SimDescription.IsMale &&
                         !Sim.ActiveActor.SimDescription.GenderPreferenceIsFemale()))
                    {
                        ...
                        Sim.ActiveActor.InteractionQueue.AddAfterCheckingForDuplicates(
                            BeHypnoticGazeFuck.Singleton.CreateInstance(actor, Sim.ActiveActor,
                                new InteractionPriority(InteractionPriorityLevel.RequiredNPCBehavior), false,
                                true));
                    }
            ...
            try
            {
                foreach (Sim sim in Sim.ActiveActor.LotCurrent.GetSims())
                {
                    ...
                    if (Settings.AutonomyChance <= 0 || RandomUtil.GetInt(0, 99) >= Settings.AutonomyChance ||
                        !Settings.VampireHypnoSex || sim.SimDescription == null || !sim.SimDescription.IsVampire ||
                        !(sim.Motives.GetMotiveValue(CommodityKind.VampireThirst) >= 10f) || sim == Sim.ActiveActor ||
                        relationship2 == null || !(relationship2.LTR.Liking > 20f) ||
                        sim.BuffManager.HasElement(BuffNames.DreamComeTrue) ||
                        Sim.ActiveActor.BuffManager.HasElement(BuffNames.Dazed) ||
                        Sim.ActiveActor.CurrentOutfitCategory == OutfitCategories.Naked ||
                        Sim.ActiveActor.InteractionQueue.Count > 1 || !GameUtils.IsInstalled(ProductVersion.EP11) ||
                        ((!sim.SimDescription.GenderPreferenceIsFemale() || !Sim.ActiveActor.SimDescription.IsFemale ||
                          !Sim.ActiveActor.SimDescription.GenderPreferenceIsFemale()) &&
                         (sim.SimDescription.GenderPreferenceIsFemale() || !Sim.ActiveActor.SimDescription.IsMale ||
                          !Sim.ActiveActor.SimDescription.GenderPreferenceIsFemale()) &&
                         (sim.SimDescription.GenderPreferenceIsFemale() || !Sim.ActiveActor.SimDescription.IsMale ||
                          Sim.ActiveActor.SimDescription.GenderPreferenceIsFemale()))) continue;
                    sim.BuffManager.AddElement(BuffNames.DreamComeTrue, 200f, Origin.FromWooHooWithOccult);
                    Sim.ActiveActor.InteractionQueue.AddAfterCheckingForDuplicates(
                        BeHypnoticGazeFuck.Singleton.CreateInstance(sim, Sim.ActiveActor,
                            new InteractionPriority(InteractionPriorityLevel.RequiredNPCBehavior), false, true));
                }
            }
            catch
            ...
            try
            {
                ...
                {
                    if (!sim2.SimDescription.IsVampire || !Settings.EvilFighter ||
                        !sim2.TraitManager.HasElement(TraitNames.Unlucky) ||
                        !sim2.TraitManager.HasElement(TraitNames.Evil) || !GameUtils.IsInstalled(ProductVersion.EP11) ||
                        !RandomUtil.CoinFlip() || !RandomUtil.CoinFlip() || !RandomUtil.CoinFlip() ||
                        !RandomUtil.CoinFlip() || !RandomUtil.CoinFlip()) continue;
            ...
            try
            {
                if (activeActor != null && activeActor.SimDescription.IsVampire &&
                    Sim.ActiveActor.TraitManager.HasElement(TraitNames.SuperVampire) && Settings.EvilFighter)
                {
                    foreach (Sim actor2 in LotManager.Actors)
                    {
                        if ((actor2 == Sim.ActiveActor || !actor2.SimDescription.IsVampire) &&
                            (actor2 == Sim.ActiveActor || !actor2.SimDescription.IsWerewolf))
                        {
                            continue;
                        }

                        if ((actor2.TraitManager.HasElement(TraitNames.Evil) &&
                             !activeActor.TraitManager.HasElement(TraitNames.Evil)) ||
                            (!actor2.TraitManager.HasElement(TraitNames.Evil) &&
                             activeActor.TraitManager.HasElement(TraitNames.Evil)))
                        {
                        ...
                        else if ((actor2.TraitManager.HasElement(TraitNames.Evil) &&
                                  activeActor.TraitManager.HasElement(TraitNames.Evil)) ||
                                 activeActor.TraitManager.HasElement(TraitNames.Evil))
                        {
                            if (!activeActor.BuffManager.HasElement(BuffNames.FeelingUnlucky) &&
                                activeActor.TraitManager.HasElement(TraitNames.Evil))
                            {
                            ...
                            if (!activeActor.BuffManager.HasElement(BuffNames.FearOfHuman) &&
                                activeActor.TraitManager.HasElement(TraitNames.Evil))
                            {
                                activeActor.BuffManager.AddElement(BuffNames.FearOfHuman, 1350f,
                                    Origin.FromBeingAroundNonFriends);
                            }

                            if (!actor2.BuffManager.HasElement(BuffNames.FeelingUnlucky) &&
                                actor2.TraitManager.HasElement(TraitNames.Evil))
                            {
                            ...
                            if (!actor2.BuffManager.HasElement(BuffNames.FearOfHuman) &&
                                actor2.TraitManager.HasElement(TraitNames.Evil))
                            {
                                actor2.BuffManager.AddElement(BuffNames.FearOfHuman, 1350f,
                                    Origin.FromBeingAroundNonFriends);
                            }

                            if (!actor2.TraitManager.HasElement(TraitNames.Evil)) continue;
            ...
            try
            {
                ...
                foreach (Household sHousehold in Household.sHouseholdList)
                {
                    ...
                    {
                        if ((!activeActor.SimDescription.IsVampire || allSimDescription == activeActor.SimDescription ||
                             !allSimDescription.IsVampire || !allSimDescription.Contactable) &&
                            (!activeActor.SimDescription.IsVampire || allSimDescription == activeActor.SimDescription ||
                             !allSimDescription.IsWerewolf || !allSimDescription.Contactable)) continue;
                        Relationship relationship5 =
                            Relationship.Get(activeActor.SimDescription, allSimDescription, true);
                        if (relationship5 != null)
                        {
                            relationship5.MakeAcquaintances();
                        }

                        if ((!allSimDescription.TraitManager.HasElement(TraitNames.Evil) ||
                             activeActor.SimDescription.TraitManager.HasElement(TraitNames.Evil)) &&
                            (allSimDescription.TraitManager.HasElement(TraitNames.Evil) ||
                             !activeActor.SimDescription.TraitManager.HasElement(TraitNames.Evil))) continue;
                        Relationship relationship6 = Relationship.Get(activeActor.SimDescription,
                            allSimDescription, false);
        ...
        public static bool IsValid(Sim sim, bool load)
        {
            ...
            return sim != null && !sim.HasBeenDestroyed && sim.SimDescription.IsZombie;
        }
        ...
        {
            return sim != null && sim.SimDescription.TeenOrAbove;
        }
        ...
        {
            if (obj == null || obj.HasBeenDestroyed) return false;
            ulong value = obj.ObjectId.Value;
            ...
            else
            {
                ...
                if (!supportedType.NeedsParts) return true;
                foreach (IGameObject containedObject in obj.GetContainedObjectList<IGameObject>(
                             obj.GetContainmentSlots()))
                {
        ...
        public static void ResetMe(IGameObject obj)
        {
            ...
            {
                if (PickBoolean.Show(
                        sim.Name + System.Environment.NewLine +
                        PassionCommon.Localize("S3_Passion.Terms.ResetSimConfirm"), false,
                        PassionCommon.Localize("S3_Passion.Terms.Yes"), PassionCommon.Localize("S3_Passion.Terms.No")))
                {
                    Player player = GetPlayer(sim);
                    if (player.IsActive)
                    {
            ...
            {
                if (gameObject == null || !PickBoolean.Show(
                        gameObject.GetLocalizedName() + System.Environment.NewLine +
                        PassionCommon.Localize("S3_Passion.Terms.ResetObjectConfirm"), false,
                        PassionCommon.Localize("S3_Passion.Terms.Yes"), PassionCommon.Localize("S3_Passion.Terms.No")))
                {
                    return;
                }
